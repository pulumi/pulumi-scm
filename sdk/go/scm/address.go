...
func NewAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scm:index/address:Address", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddress(ctx *pulumi.Context,
	...
	var resource Address
	err := ctx.ReadResource("scm:index/address:Address", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Tags assocaited with the address object
func (o AddressOutput) Tags() pulumi.StringArrayOutput {
