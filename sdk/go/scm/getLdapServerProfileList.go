...
// The max number of items to return. Default: 200.
func (o GetLdapServerProfileListResultOutput) Limit() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetLdapServerProfileListResult) *int { return v.Limit }).(pulumi.IntPtrOutput)
}
...
// The offset of the first item to return.
func (o GetLdapServerProfileListResultOutput) Offset() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetLdapServerProfileListResult) *int { return v.Offset }).(pulumi.IntPtrOutput)
}
