...
// The max number of items to return. Default: 200.
func (o GetAntiSpywareProfileListResultOutput) Limit() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetAntiSpywareProfileListResult) *int { return v.Limit }).(pulumi.IntPtrOutput)
}
...
// The offset of the first item to return.
func (o GetAntiSpywareProfileListResultOutput) Offset() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetAntiSpywareProfileListResult) *int { return v.Offset }).(pulumi.IntPtrOutput)
}
