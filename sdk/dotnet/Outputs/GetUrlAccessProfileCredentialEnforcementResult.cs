...
namespace Pulumi.Scm.Outputs
{
    ...
    [OutputType]
    public sealed class GetUrlAccessProfileCredentialEnforcementResult
    {
        /// <summary>
        /// The Alerts param.
        /// </summary>
        ...
        /// The Mode param.
        /// </summary>
        public readonly Outputs.GetUrlAccessProfileCredentialEnforcementModeResult Mode;

        [OutputConstructor]
        private GetUrlAccessProfileCredentialEnforcementResult(
            ...
            Outputs.GetUrlAccessProfileCredentialEnforcementModeResult mode)
        {
            Alerts = alerts;
            Allows = allows;
            Blocks = blocks;
