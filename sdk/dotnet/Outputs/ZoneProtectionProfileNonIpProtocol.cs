...
namespace Pulumi.Scm.Outputs
{
    ...
    [OutputType]
    public sealed class ZoneProtectionProfileNonIpProtocol
    {
        /// <summary>
        ...
        /// Protocol
        /// </summary>
        public readonly ImmutableArray<Outputs.ZoneProtectionProfileNonIpProtocolProtocol> Protocols;

        [OutputConstructor]
        private ZoneProtectionProfileNonIpProtocol(
            string? listType,

            ImmutableArray<Outputs.ZoneProtectionProfileNonIpProtocolProtocol> protocols)
        {
            ListType = listType;
            Protocols = protocols;
        }
