...
namespace Pulumi.Scm.Outputs
{
    ...
    [OutputType]
    public sealed class GetZoneProtectionProfileNonIpProtocolResult
    {
        /// <summary>
        ...
        /// Protocol
        /// </summary>
        public readonly ImmutableArray<Outputs.GetZoneProtectionProfileNonIpProtocolProtocolResult> Protocols;

        [OutputConstructor]
        private GetZoneProtectionProfileNonIpProtocolResult(
            string listType,

            ImmutableArray<Outputs.GetZoneProtectionProfileNonIpProtocolProtocolResult> protocols)
        {
            ListType = listType;
            Protocols = protocols;
        }
