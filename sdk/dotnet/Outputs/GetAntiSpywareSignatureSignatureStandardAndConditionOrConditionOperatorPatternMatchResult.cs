...
namespace Pulumi.Scm.Outputs
{
    ...
    public sealed class GetAntiSpywareSignatureSignatureStandardAndConditionOrConditionOperatorPatternMatchResult
    {
        ...
        [OutputConstructor]
        private GetAntiSpywareSignatureSignatureStandardAndConditionOrConditionOperatorPatternMatchResult(
            string context,
            ...
            ImmutableArray<Outputs.GetAntiSpywareSignatureSignatureStandardAndConditionOrConditionOperatorPatternMatchQualifierResult> qualifiers)
        {
            Context = context;
            Negate = negate;
            Pattern = pattern;
