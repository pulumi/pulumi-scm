...
export class AntiSpywareSignature extends pulumi.CustomResource {
     ...
     * The Bugtraqs param.
     */
    public readonly bugtraqs!: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    public readonly defaultAction!: pulumi.Output<outputs.AntiSpywareSignatureDefaultAction | undefined>;
    /**
     * The Device param.
     */
     ...
     */
    public readonly references!: pulumi.Output<string[] | undefined>;
    /**
     ...
     * The Signature param.
     */
    public readonly signature!: pulumi.Output<outputs.AntiSpywareSignatureSignature | undefined>;
    /**
     * The Snippet param.
     */
     ...
     */
    public readonly threatId!: pulumi.Output<number>;
    /**
     * The Threatname param. String length must not exceed 1024 characters.
     */
    public readonly threatname!: pulumi.Output<string>;
    /**
     * The Vendors param.
     */
    public readonly vendors!: pulumi.Output<string[] | undefined>;
    ...
    constructor(name: string, argsOrState?: AntiSpywareSignatureArgs | AntiSpywareSignatureState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["bugtraqs"] = state ? state.bugtraqs : undefined;
            ...
            resourceInputs["threatId"] = state ? state.threatId : undefined;
            resourceInputs["threatname"] = state ? state.threatname : undefined;
            resourceInputs["vendors"] = state ? state.vendors : undefined;
        } else {
            const args = argsOrState as AntiSpywareSignatureArgs | undefined;
            if ((!args || args.threatId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'threatId'");
            }
            if ((!args || args.threatname === undefined) && !opts.urn) {
                throw new Error("Missing required property 'threatname'");
            }
            resourceInputs["bugtraqs"] = args ? args.bugtraqs : undefined;
            ...
            resourceInputs["threatId"] = args ? args.threatId : undefined;
            resourceInputs["threatname"] = args ? args.threatname : undefined;
