 ...
 */
export interface GetWildfireAntiVirusProfileListArgs {
    /**
     * The Device param.
     */
    device?: string;
 ...
 */
export interface GetWildfireAntiVirusProfileListResult {
    /**
     * The Data param.
     */
    readonly datas: outputs.GetWildfireAntiVirusProfileListData[];
    /**
     * The Device param.
     */
 ...
 * A collection of arguments for invoking getWildfireAntiVirusProfileList.
 */
export interface GetWildfireAntiVirusProfileListOutputArgs {
    /**
     * The Device param.
     */
