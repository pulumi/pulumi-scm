 ...
 */
export class IptagMatchList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IptagMatchListState, opts?: pulumi.CustomResourceOptions): IptagMatchList {
        return new IptagMatchList(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scm:index/iptagMatchList:IptagMatchList';

    /**
     * Returns true if the given object is an instance of IptagMatchList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IptagMatchList {
    ...
    constructor(name: string, argsOrState?: IptagMatchListArgs | IptagMatchListState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IptagMatchListState | undefined;
            ...
            const args = argsOrState as IptagMatchListArgs | undefined;
