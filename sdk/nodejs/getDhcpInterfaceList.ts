...
export function getDhcpInterfaceList(args?: GetDhcpInterfaceListArgs, opts?: pulumi.InvokeOptions): Promise<GetDhcpInterfaceListResult> {
    ...
    return pulumi.runtime.invoke("scm:index/getDhcpInterfaceList:getDhcpInterfaceList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
 ...
 */
export interface GetDhcpInterfaceListArgs {
    /**
 ...
 */
export interface GetDhcpInterfaceListResult {
    /**
     * The data.
     */
    readonly datas: outputs.GetDhcpInterfaceListData[];
    /**
     * The device of the item.
     */
...
export function getDhcpInterfaceListOutput(args?: GetDhcpInterfaceListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDhcpInterfaceListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scm:index/getDhcpInterfaceList:getDhcpInterfaceList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
 ...
 * A collection of arguments for invoking getDhcpInterfaceList.
 */
export interface GetDhcpInterfaceListOutputArgs {
    /**
     * The device of the item.
     */
