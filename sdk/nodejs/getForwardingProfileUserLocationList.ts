 ...
 * ```
 */
export function getForwardingProfileUserLocationList(args?: GetForwardingProfileUserLocationListArgs, opts?: pulumi.InvokeOptions): Promise<GetForwardingProfileUserLocationListResult> {
    args = args || {};
 ...
 * ```
 */
export function getForwardingProfileUserLocationListOutput(args?: GetForwardingProfileUserLocationListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetForwardingProfileUserLocationListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
