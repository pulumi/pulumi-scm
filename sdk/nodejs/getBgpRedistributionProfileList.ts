...
export function getBgpRedistributionProfileList(args?: GetBgpRedistributionProfileListArgs, opts?: pulumi.InvokeOptions): Promise<GetBgpRedistributionProfileListResult> {
    ...
    return pulumi.runtime.invoke("scm:index/getBgpRedistributionProfileList:getBgpRedistributionProfileList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
 ...
 */
export interface GetBgpRedistributionProfileListArgs {
    /**
 ...
 */
export interface GetBgpRedistributionProfileListResult {
    /**
     * The data.
     */
    readonly datas: outputs.GetBgpRedistributionProfileListData[];
    /**
     * The device of the item.
     */
...
export function getBgpRedistributionProfileListOutput(args?: GetBgpRedistributionProfileListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBgpRedistributionProfileListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scm:index/getBgpRedistributionProfileList:getBgpRedistributionProfileList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
 ...
 * A collection of arguments for invoking getBgpRedistributionProfileList.
 */
export interface GetBgpRedistributionProfileListOutputArgs {
    /**
     * The device of the item.
     */
