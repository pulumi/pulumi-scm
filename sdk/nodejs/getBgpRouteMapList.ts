...
export function getBgpRouteMapList(args?: GetBgpRouteMapListArgs, opts?: pulumi.InvokeOptions): Promise<GetBgpRouteMapListResult> {
    ...
    return pulumi.runtime.invoke("scm:index/getBgpRouteMapList:getBgpRouteMapList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
 ...
 */
export interface GetBgpRouteMapListArgs {
    /**
 ...
 */
export interface GetBgpRouteMapListResult {
    /**
     * The data.
     */
    readonly datas: outputs.GetBgpRouteMapListData[];
    /**
     * The device of the item.
     */
...
export function getBgpRouteMapListOutput(args?: GetBgpRouteMapListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBgpRouteMapListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scm:index/getBgpRouteMapList:getBgpRouteMapList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
 ...
 * A collection of arguments for invoking getBgpRouteMapList.
 */
export interface GetBgpRouteMapListOutputArgs {
    /**
     * The device of the item.
     */
