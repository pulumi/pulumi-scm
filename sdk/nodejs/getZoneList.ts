...
export function getZoneList(args?: GetZoneListArgs, opts?: pulumi.InvokeOptions): Promise<GetZoneListResult> {
    ...
    return pulumi.runtime.invoke("scm:index/getZoneList:getZoneList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
...
export interface GetZoneListResult {
     ...
     * The data.
     */
    readonly datas: outputs.GetZoneListData[];
    /**
     * The device of the item.
     */
...
export function getZoneListOutput(args?: GetZoneListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZoneListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scm:index/getZoneList:getZoneList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
