...
export function getInterfaceManagementProfileList(args?: GetInterfaceManagementProfileListArgs, opts?: pulumi.InvokeOptions): Promise<GetInterfaceManagementProfileListResult> {
    ...
    return pulumi.runtime.invoke("scm:index/getInterfaceManagementProfileList:getInterfaceManagementProfileList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
 ...
 */
export interface GetInterfaceManagementProfileListArgs {
    /**
 ...
 */
export interface GetInterfaceManagementProfileListResult {
    /**
     * The data.
     */
    readonly datas: outputs.GetInterfaceManagementProfileListData[];
    /**
     * The device of the item.
     */
...
export function getInterfaceManagementProfileListOutput(args?: GetInterfaceManagementProfileListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInterfaceManagementProfileListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scm:index/getInterfaceManagementProfileList:getInterfaceManagementProfileList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
 ...
 * A collection of arguments for invoking getInterfaceManagementProfileList.
 */
export interface GetInterfaceManagementProfileListOutputArgs {
    /**
     * The device of the item.
     */
