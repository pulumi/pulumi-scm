...
export function getLogicalRouterList(args?: GetLogicalRouterListArgs, opts?: pulumi.InvokeOptions): Promise<GetLogicalRouterListResult> {
    ...
    return pulumi.runtime.invoke("scm:index/getLogicalRouterList:getLogicalRouterList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
...
export function getLogicalRouterListOutput(args?: GetLogicalRouterListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogicalRouterListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scm:index/getLogicalRouterList:getLogicalRouterList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
