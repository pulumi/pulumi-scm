 ...
 * ```
 */
export function getForwardingProfileRegionalAndCustomProxyList(args?: GetForwardingProfileRegionalAndCustomProxyListArgs, opts?: pulumi.InvokeOptions): Promise<GetForwardingProfileRegionalAndCustomProxyListResult> {
    args = args || {};
 ...
 * ```
 */
export function getForwardingProfileRegionalAndCustomProxyListOutput(args?: GetForwardingProfileRegionalAndCustomProxyListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetForwardingProfileRegionalAndCustomProxyListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
