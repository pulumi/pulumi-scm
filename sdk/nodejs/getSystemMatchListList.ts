...
export function getSystemMatchListList(args?: GetSystemMatchListListArgs, opts?: pulumi.InvokeOptions): Promise<GetSystemMatchListListResult> {
    ...
    return pulumi.runtime.invoke("scm:index/getSystemMatchListList:getSystemMatchListList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
...
export function getSystemMatchListListOutput(args?: GetSystemMatchListListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSystemMatchListListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scm:index/getSystemMatchListList:getSystemMatchListList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
