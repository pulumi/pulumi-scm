 ...
 * ```
 */
export function getForwardingProfileList(args?: GetForwardingProfileListArgs, opts?: pulumi.InvokeOptions): Promise<GetForwardingProfileListResult> {
    args = args || {};
 ...
 * ```
 */
export function getForwardingProfileListOutput(args?: GetForwardingProfileListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetForwardingProfileListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
