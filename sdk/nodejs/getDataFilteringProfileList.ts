 ...
 * ```
 */
export function getDataFilteringProfileList(args?: GetDataFilteringProfileListArgs, opts?: pulumi.InvokeOptions): Promise<GetDataFilteringProfileListResult> {
    args = args || {};
 ...
 * ```
 */
export function getDataFilteringProfileListOutput(args?: GetDataFilteringProfileListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDataFilteringProfileListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
