...
export function getLayer3SubinterfaceList(args?: GetLayer3SubinterfaceListArgs, opts?: pulumi.InvokeOptions): Promise<GetLayer3SubinterfaceListResult> {
    ...
    return pulumi.runtime.invoke("scm:index/getLayer3SubinterfaceList:getLayer3SubinterfaceList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
...
export function getLayer3SubinterfaceListOutput(args?: GetLayer3SubinterfaceListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLayer3SubinterfaceListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("scm:index/getLayer3SubinterfaceList:getLayer3SubinterfaceList", {
        "device": args.device,
        "folder": args.folder,
        "limit": args.limit,
        "name": args.name,
