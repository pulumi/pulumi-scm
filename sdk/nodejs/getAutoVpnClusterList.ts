 ...
 * ```
 */
export function getAutoVpnClusterList(args?: GetAutoVpnClusterListArgs, opts?: pulumi.InvokeOptions): Promise<GetAutoVpnClusterListResult> {
    args = args || {};
 ...
 * ```
 */
export function getAutoVpnClusterListOutput(args?: GetAutoVpnClusterListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutoVpnClusterListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
