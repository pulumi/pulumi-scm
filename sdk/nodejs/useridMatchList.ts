 ...
 */
export class UseridMatchList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UseridMatchListState, opts?: pulumi.CustomResourceOptions): UseridMatchList {
        return new UseridMatchList(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scm:index/useridMatchList:UseridMatchList';

    /**
     * Returns true if the given object is an instance of UseridMatchList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is UseridMatchList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === UseridMatchList.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: UseridMatchListArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: UseridMatchListArgs | UseridMatchListState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as UseridMatchListState | undefined;
            ...
            const args = argsOrState as UseridMatchListArgs | undefined;
        ...
        super(UseridMatchList.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface UseridMatchListState {
    /**
     * Description of the userid match list entry
     */
 ...
 */
export interface UseridMatchListArgs {
    /**
     * Description of the userid match list entry
     */
    description?: pulumi.Input<string>;
