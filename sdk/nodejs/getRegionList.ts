 ...
 *
 * const example = scm.getRegionList({
 *     folder: "Shared",
 * });
 * ```
 */
 ...
 */
export interface GetRegionListArgs {
    /**
     * The Device param.
     */
    device?: string;
 ...
 */
export interface GetRegionListResult {
    /**
     * The Data param.
     */
    readonly datas: outputs.GetRegionListData[];
    /**
     * The Device param.
     */
 ...
 * A collection of arguments for invoking getRegionList.
 */
export interface GetRegionListOutputArgs {
    /**
     * The Device param.
     */
