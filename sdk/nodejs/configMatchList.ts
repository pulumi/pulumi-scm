 ...
 */
export class ConfigMatchList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConfigMatchListState, opts?: pulumi.CustomResourceOptions): ConfigMatchList {
        return new ConfigMatchList(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scm:index/configMatchList:ConfigMatchList';

    /**
     * Returns true if the given object is an instance of ConfigMatchList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ConfigMatchList {
    ...
    constructor(name: string, argsOrState?: ConfigMatchListArgs | ConfigMatchListState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ConfigMatchListState | undefined;
            ...
            const args = argsOrState as ConfigMatchListArgs | undefined;
