...
__all__ = [
    'GetForwardingProfileUserLocationListResult',
    'AwaitableGetForwardingProfileUserLocationListResult',
    'get_forwarding_profile_user_location_list',
    'get_forwarding_profile_user_location_list_output',
]

@pulumi.output_type
class GetForwardingProfileUserLocationListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetForwardingProfileUserLocationListDataResult']:
        """
        The data.
        """
...
class AwaitableGetForwardingProfileUserLocationListResult(GetForwardingProfileUserLocationListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetForwardingProfileUserLocationListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_forwarding_profile_user_location_list(device: Optional[_builtins.str] = None,
                                              folder: Optional[_builtins.str] = None,
                                              limit: Optional[_builtins.int] = None,
                                              name: Optional[_builtins.str] = None,
                                              offset: Optional[_builtins.int] = None,
                                              snippet: Optional[_builtins.str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetForwardingProfileUserLocationListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getForwardingProfileUserLocationList:getForwardingProfileUserLocationList', __args__, opts=opts, typ=GetForwardingProfileUserLocationListResult).value

    return AwaitableGetForwardingProfileUserLocationListResult(
...
def get_forwarding_profile_user_location_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                     folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                     limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                                     name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                     offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                                     snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetForwardingProfileUserLocationListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getForwardingProfileUserLocationList:getForwardingProfileUserLocationList', __args__, opts=opts, typ=GetForwardingProfileUserLocationListResult)
    return __ret__.apply(lambda __response__: GetForwardingProfileUserLocationListResult(
