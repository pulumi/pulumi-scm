...
class _KerberosServerProfileState:
    def __init__(__self__, *,
                 ...
                 folder: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 servers: pulumi.Input[Optional[Sequence[pulumi.Input['KerberosServerProfileServerArgs']]]] = None,
                 snippet: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def servers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['KerberosServerProfileServerArgs']]]]:
        """
        The Kerberos server configuration
        """
        return pulumi.get(self, "servers")
    ...
    @servers.setter
    def servers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['KerberosServerProfileServerArgs']]]]):
        pulumi.set(self, "servers", value)
