...
class GetAppOverrideRuleListResult:
    ...
    """
    def __init__(__self__, datas=None, device=None, folder=None, limit=None, name=None, offset=None, position=None, snippet=None, tfid=None, total=None):
...
def get_app_override_rule_list_output(device: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
