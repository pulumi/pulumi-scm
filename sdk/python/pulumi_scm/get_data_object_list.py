...
__all__ = [
    'GetDataObjectListResult',
    'AwaitableGetDataObjectListResult',
    'get_data_object_list',
    'get_data_object_list_output',
]

@pulumi.output_type
class GetDataObjectListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetDataObjectListDataResult']:
        """
        The data.
        """
...
class AwaitableGetDataObjectListResult(GetDataObjectListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataObjectListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_data_object_list(device: Optional[_builtins.str] = None,
                         folder: Optional[_builtins.str] = None,
                         limit: Optional[_builtins.int] = None,
                         name: Optional[_builtins.str] = None,
                         offset: Optional[_builtins.int] = None,
                         snippet: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataObjectListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getDataObjectList:getDataObjectList', __args__, opts=opts, typ=GetDataObjectListResult).value

    return AwaitableGetDataObjectListResult(
...
def get_data_object_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDataObjectListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getDataObjectList:getDataObjectList', __args__, opts=opts, typ=GetDataObjectListResult)
    return __ret__.apply(lambda __response__: GetDataObjectListResult(
