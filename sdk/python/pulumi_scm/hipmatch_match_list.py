...
__all__ = ['HipmatchMatchListArgs', 'HipmatchMatchList']

@pulumi.input_type
class HipmatchMatchListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Description of the hipmatch match list entry
        :param pulumi.Input[_builtins.str] device: The device in which the resource is defined
        :param pulumi.Input[_builtins.str] filter: Filter of the hipmatch match list entry
        :param pulumi.Input[_builtins.str] folder: The folder in which the resource is defined
               
               > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
        :param pulumi.Input[_builtins.str] name: Name of the hipmatch match list entry
        :param pulumi.Input[_builtins.bool] quarantine: Quarantine Flag of the hipmatch match list entry
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] send_emails: Send Email List of the hipmatch match list entry
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] send_https: Send HTTP List of the hipmatch match list entry
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] send_snmptraps: Send SNMP Trap List of the hipmatch match list entry
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] send_syslogs: Send Sys Log List of the hipmatch match list entry
        :param pulumi.Input[_builtins.bool] send_to_panorama: Send to Panorama Flag of the hipmatch match list entry
...
@pulumi.type_token("scm:index/hipmatchMatchList:HipmatchMatchList")
class HipmatchMatchList(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        **Note:** Please provide just one of folder, snippet, or device for the import command.
        ...
        :param str resource_name: The name of the resource.
        :param HipmatchMatchListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(HipmatchMatchListArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = HipmatchMatchListArgs.__new__(HipmatchMatchListArgs)
        ...
        super(HipmatchMatchList, __self__).__init__(
            'scm:index/hipmatchMatchList:HipmatchMatchList',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            send_to_panorama: Optional[pulumi.Input[_builtins.bool]] = None,
            snippet: Optional[pulumi.Input[_builtins.str]] = None,
            tfid: Optional[pulumi.Input[_builtins.str]] = None) -> 'HipmatchMatchList':
        """
        ...
        __props__ = _HipmatchMatchListState.__new__(_HipmatchMatchListState)
        ...
        return HipmatchMatchList(resource_name, opts=opts, __props__=__props__)
