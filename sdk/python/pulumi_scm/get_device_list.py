...
class GetDeviceListResult:
    ...
    """
    def __init__(__self__, datas=None, device=None, folder=None, limit=None, name=None, offset=None, pagination=None, snippet=None, tfid=None, total=None):
...
def get_device_list(device: Optional[_builtins.str] = None,
...
def get_device_list_output(device: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                           ...
                           pagination: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
