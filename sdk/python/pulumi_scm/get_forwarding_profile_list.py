...
__all__ = [
    'GetForwardingProfileListResult',
    'AwaitableGetForwardingProfileListResult',
    'get_forwarding_profile_list',
    'get_forwarding_profile_list_output',
]

@pulumi.output_type
class GetForwardingProfileListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetForwardingProfileListDataResult']:
        """
        The data.
        """
...
class AwaitableGetForwardingProfileListResult(GetForwardingProfileListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetForwardingProfileListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_forwarding_profile_list(device: Optional[_builtins.str] = None,
                                folder: Optional[_builtins.str] = None,
                                limit: Optional[_builtins.int] = None,
                                name: Optional[_builtins.str] = None,
                                offset: Optional[_builtins.int] = None,
                                snippet: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetForwardingProfileListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getForwardingProfileList:getForwardingProfileList', __args__, opts=opts, typ=GetForwardingProfileListResult).value

    return AwaitableGetForwardingProfileListResult(
...
def get_forwarding_profile_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                       name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                       snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetForwardingProfileListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getForwardingProfileList:getForwardingProfileList', __args__, opts=opts, typ=GetForwardingProfileListResult)
    return __ret__.apply(lambda __response__: GetForwardingProfileListResult(
