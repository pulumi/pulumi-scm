...
class ProviderArgs:
    def __init__(__self__, *,
                 auth_file: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def auth_file(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @auth_file.setter
    def auth_file(self, value: pulumi.Input[Optional[_builtins.str]]):
