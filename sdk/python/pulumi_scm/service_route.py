...
class ServiceRouteArgs:
    def __init__(__self__, *,
                 ...
                 route: pulumi.Input[Optional['ServiceRouteRouteArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def route(self) -> pulumi.Input[Optional['ServiceRouteRouteArgs']]:
        """
        Route
        """
    ...
    @route.setter
    def route(self, value: pulumi.Input[Optional['ServiceRouteRouteArgs']]):
