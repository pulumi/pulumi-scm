...
@CustomType
public final class GetRoutePrefixListListData {
    /**
     * @return Description
     * 
     */
    ...
    public static Builder builder(GetRoutePrefixListListData defaults) {
    ...
    public static final class Builder {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetRoutePrefixListListData", "description");
            }
        ...
        public Builder device(String device) {
            if (device == null) {
              throw new MissingRequiredPropertyException("GetRoutePrefixListListData", "device");
            }
            this.device = device;
            return this;
        }
        ...
        public Builder folder(String folder) {
            if (folder == null) {
              throw new MissingRequiredPropertyException("GetRoutePrefixListListData", "folder");
            }
            this.folder = folder;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetRoutePrefixListListData", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder snippet(String snippet) {
            if (snippet == null) {
              throw new MissingRequiredPropertyException("GetRoutePrefixListListData", "snippet");
            }
        ...
        public Builder tfid(String tfid) {
            if (tfid == null) {
              throw new MissingRequiredPropertyException("GetRoutePrefixListListData", "tfid");
            }
            this.tfid = tfid;
            return this;
        }
