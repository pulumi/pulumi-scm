...
public final class GetAppOverrideRuleListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAppOverrideRuleListArgs Empty = new GetAppOverrideRuleListArgs();
    ...
    private GetAppOverrideRuleListArgs() {}

    private GetAppOverrideRuleListArgs(GetAppOverrideRuleListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetAppOverrideRuleListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAppOverrideRuleListArgs();
        }

        public Builder(GetAppOverrideRuleListArgs defaults) {
            $ = new GetAppOverrideRuleListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAppOverrideRuleListArgs build() {
            if ($.position == null) {
                throw new MissingRequiredPropertyException("GetAppOverrideRuleListArgs", "position");
            }
            return $;
        }
    }
