...
public final class GetVpnSettingListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVpnSettingListArgs Empty = new GetVpnSettingListArgs();
    ...
    private GetVpnSettingListArgs() {}

    private GetVpnSettingListArgs(GetVpnSettingListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetVpnSettingListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVpnSettingListArgs();
        }

        public Builder(GetVpnSettingListArgs defaults) {
            $ = new GetVpnSettingListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVpnSettingListArgs build() {
            return $;
        }
    }
