...
public final class HipObjectNetworkInfoCriteriaNetworkIsNotWifi {
    ...
    public static Builder builder(HipObjectNetworkInfoCriteriaNetworkIsNotWifi defaults) {
    ...
    public static final class Builder {
        private @Nullable String ssid;
        public Builder() {}
        public Builder(HipObjectNetworkInfoCriteriaNetworkIsNotWifi defaults) {
        ...
        public HipObjectNetworkInfoCriteriaNetworkIsNotWifi build() {
            final var _resultValue = new HipObjectNetworkInfoCriteriaNetworkIsNotWifi();
