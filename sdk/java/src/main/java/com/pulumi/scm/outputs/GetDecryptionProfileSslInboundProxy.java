...
@CustomType
public final class GetDecryptionProfileSslInboundProxy {
    /**
    ...
    private GetDecryptionProfileSslInboundProxy() {}
    /**
     * @return The BlockIfHsmUnavailable param. Default: `false`.
     * 
     */
    ...
    public static Builder builder(GetDecryptionProfileSslInboundProxy defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean blockUnsupportedVersion;
        public Builder() {}
        public Builder(GetDecryptionProfileSslInboundProxy defaults) {
        ...
        public Builder blockIfHsmUnavailable(Boolean blockIfHsmUnavailable) {
            if (blockIfHsmUnavailable == null) {
              throw new MissingRequiredPropertyException("GetDecryptionProfileSslInboundProxy", "blockIfHsmUnavailable");
            }
        ...
        public Builder blockIfNoResource(Boolean blockIfNoResource) {
            if (blockIfNoResource == null) {
              throw new MissingRequiredPropertyException("GetDecryptionProfileSslInboundProxy", "blockIfNoResource");
            }
        ...
        public Builder blockUnsupportedCipher(Boolean blockUnsupportedCipher) {
            if (blockUnsupportedCipher == null) {
              throw new MissingRequiredPropertyException("GetDecryptionProfileSslInboundProxy", "blockUnsupportedCipher");
            }
        ...
        public Builder blockUnsupportedVersion(Boolean blockUnsupportedVersion) {
            if (blockUnsupportedVersion == null) {
              throw new MissingRequiredPropertyException("GetDecryptionProfileSslInboundProxy", "blockUnsupportedVersion");
            }
            this.blockUnsupportedVersion = blockUnsupportedVersion;
            return this;
        }
        public GetDecryptionProfileSslInboundProxy build() {
            final var _resultValue = new GetDecryptionProfileSslInboundProxy();
