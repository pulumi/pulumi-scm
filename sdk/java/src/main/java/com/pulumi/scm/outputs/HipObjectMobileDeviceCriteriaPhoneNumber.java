...
public final class HipObjectMobileDeviceCriteriaPhoneNumber {
    ...
    public static Builder builder(HipObjectMobileDeviceCriteriaPhoneNumber defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String isNot;
        public Builder() {}
        public Builder(HipObjectMobileDeviceCriteriaPhoneNumber defaults) {
        ...
        public HipObjectMobileDeviceCriteriaPhoneNumber build() {
            final var _resultValue = new HipObjectMobileDeviceCriteriaPhoneNumber();
