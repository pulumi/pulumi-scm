...
public final class AuthenticationProfileMethodTacplus {
    ...
    public static Builder builder(AuthenticationProfileMethodTacplus defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String serverProfile;
        public Builder() {}
        public Builder(AuthenticationProfileMethodTacplus defaults) {
        ...
        public AuthenticationProfileMethodTacplus build() {
            final var _resultValue = new AuthenticationProfileMethodTacplus();
