...
public final class GetSiteListPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSiteListPlainArgs Empty = new GetSiteListPlainArgs();
    ...
    private GetSiteListPlainArgs() {}

    private GetSiteListPlainArgs(GetSiteListPlainArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetSiteListPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSiteListPlainArgs();
        }

        public Builder(GetSiteListPlainArgs defaults) {
            $ = new GetSiteListPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSiteListPlainArgs build() {
            return $;
        }
    }
