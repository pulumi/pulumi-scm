...
public final class GetSdwanRuleListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSdwanRuleListArgs Empty = new GetSdwanRuleListArgs();
    ...
    private GetSdwanRuleListArgs() {}

    private GetSdwanRuleListArgs(GetSdwanRuleListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetSdwanRuleListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSdwanRuleListArgs();
        }

        public Builder(GetSdwanRuleListArgs defaults) {
            $ = new GetSdwanRuleListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSdwanRuleListArgs build() {
            return $;
        }
    }
