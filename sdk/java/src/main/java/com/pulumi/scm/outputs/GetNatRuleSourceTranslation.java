...
public final class GetNatRuleSourceTranslation {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder fallback(GetNatRuleSourceTranslationFallback fallback) {
            if (fallback == null) {
        ...
        public Builder translatedAddressArrays(List<String> translatedAddressArrays) {
            if (translatedAddressArrays == null) {
              throw new MissingRequiredPropertyException("GetNatRuleSourceTranslation", "translatedAddressArrays");
            }
        ...
        public Builder translatedAddressSingle(String translatedAddressSingle) {
            if (translatedAddressSingle == null) {
              throw new MissingRequiredPropertyException("GetNatRuleSourceTranslation", "translatedAddressSingle");
            }
