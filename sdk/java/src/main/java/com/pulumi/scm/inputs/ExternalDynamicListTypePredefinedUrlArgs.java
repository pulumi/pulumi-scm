...
public final class ExternalDynamicListTypePredefinedUrlArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExternalDynamicListTypePredefinedUrlArgs Empty = new ExternalDynamicListTypePredefinedUrlArgs();
    ...
    private ExternalDynamicListTypePredefinedUrlArgs() {}

    private ExternalDynamicListTypePredefinedUrlArgs(ExternalDynamicListTypePredefinedUrlArgs $) {
    ...
    public static Builder builder(ExternalDynamicListTypePredefinedUrlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExternalDynamicListTypePredefinedUrlArgs();
        }

        public Builder(ExternalDynamicListTypePredefinedUrlArgs defaults) {
            $ = new ExternalDynamicListTypePredefinedUrlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ExternalDynamicListTypePredefinedUrlArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("ExternalDynamicListTypePredefinedUrlArgs", "url");
            }
            return $;
        }
    }
