...
public final class IpsecTunnelAutoKeyProxyIdProtocolUdp {
    ...
    public static Builder builder(IpsecTunnelAutoKeyProxyIdProtocolUdp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer remotePort;
        public Builder() {}
        public Builder(IpsecTunnelAutoKeyProxyIdProtocolUdp defaults) {
        ...
        public IpsecTunnelAutoKeyProxyIdProtocolUdp build() {
            final var _resultValue = new IpsecTunnelAutoKeyProxyIdProtocolUdp();
