...
public final class HipObjectHostInfoCriteriaClientVersionArgs extends com.pulumi.resources.ResourceArgs {

    public static final HipObjectHostInfoCriteriaClientVersionArgs Empty = new HipObjectHostInfoCriteriaClientVersionArgs();
    ...
    private HipObjectHostInfoCriteriaClientVersionArgs() {}

    private HipObjectHostInfoCriteriaClientVersionArgs(HipObjectHostInfoCriteriaClientVersionArgs $) {
    ...
    public static Builder builder(HipObjectHostInfoCriteriaClientVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HipObjectHostInfoCriteriaClientVersionArgs();
        }

        public Builder(HipObjectHostInfoCriteriaClientVersionArgs defaults) {
            $ = new HipObjectHostInfoCriteriaClientVersionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HipObjectHostInfoCriteriaClientVersionArgs build() {
            return $;
        }
    }
