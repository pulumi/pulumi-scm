...
@CustomType
public final class HipObjectMobileDeviceCriteriaTag {
    /**
    ...
    public static Builder builder(HipObjectMobileDeviceCriteriaTag defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String isNot;
        public Builder() {}
        public Builder(HipObjectMobileDeviceCriteriaTag defaults) {
        ...
        public HipObjectMobileDeviceCriteriaTag build() {
            final var _resultValue = new HipObjectMobileDeviceCriteriaTag();
