...
@CustomType
public final class GetLogicalRouterVrfOspfGracefulRestart {
    /**
     * @return Enable
     * 
     */
    ...
    public static Builder builder(GetLogicalRouterVrfOspfGracefulRestart defaults) {
    ...
    public static final class Builder {
        ...
        public Builder enable(Boolean enable) {
            if (enable == null) {
              throw new MissingRequiredPropertyException("GetLogicalRouterVrfOspfGracefulRestart", "enable");
            }
            this.enable = enable;
            return this;
        }
        ...
        public Builder helperEnable(Boolean helperEnable) {
            if (helperEnable == null) {
              throw new MissingRequiredPropertyException("GetLogicalRouterVrfOspfGracefulRestart", "helperEnable");
            }
        ...
        public GetLogicalRouterVrfOspfGracefulRestart build() {
            final var _resultValue = new GetLogicalRouterVrfOspfGracefulRestart();
