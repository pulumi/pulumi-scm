...
public final class RemoteNetworkProtocolBgp {
    ...
    public static Builder builder(RemoteNetworkProtocolBgp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean summarizeMobileUserRoutes;
        public Builder() {}
        public Builder(RemoteNetworkProtocolBgp defaults) {
        ...
        public RemoteNetworkProtocolBgp build() {
            final var _resultValue = new RemoteNetworkProtocolBgp();
