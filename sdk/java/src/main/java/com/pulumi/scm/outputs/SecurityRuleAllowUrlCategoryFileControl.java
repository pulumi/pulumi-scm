...
@CustomType
public final class SecurityRuleAllowUrlCategoryFileControl {
    /**
     * @return Download
     * 
     */
    ...
    private SecurityRuleAllowUrlCategoryFileControl() {}
    /**
     * @return Download
     * 
     */
    ...
    public static Builder builder(SecurityRuleAllowUrlCategoryFileControl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String upload;
        public Builder() {}
        public Builder(SecurityRuleAllowUrlCategoryFileControl defaults) {
        ...
        public SecurityRuleAllowUrlCategoryFileControl build() {
            final var _resultValue = new SecurityRuleAllowUrlCategoryFileControl();
