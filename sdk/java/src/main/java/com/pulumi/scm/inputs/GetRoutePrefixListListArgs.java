...
public final class GetRoutePrefixListListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRoutePrefixListListArgs Empty = new GetRoutePrefixListListArgs();
    ...
    private GetRoutePrefixListListArgs() {}

    private GetRoutePrefixListListArgs(GetRoutePrefixListListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetRoutePrefixListListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRoutePrefixListListArgs();
        }

        public Builder(GetRoutePrefixListListArgs defaults) {
            $ = new GetRoutePrefixListListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRoutePrefixListListArgs build() {
            return $;
        }
    }
