...
public final class Layer3SubinterfaceDdnsConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Layer3SubinterfaceDdnsConfigArgs(Layer3SubinterfaceDdnsConfigArgs $) {
    ...
    public static Builder builder(Layer3SubinterfaceDdnsConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new Layer3SubinterfaceDdnsConfigArgs();
        }

        public Builder(Layer3SubinterfaceDdnsConfigArgs defaults) {
            $ = new Layer3SubinterfaceDdnsConfigArgs(Objects.requireNonNull(defaults));
        }
