...
@CustomType
public final class BgpAddressFamilyProfileIpv4Ipv4MulticastAddPath {
    /**
    ...
    public static Builder builder(BgpAddressFamilyProfileIpv4Ipv4MulticastAddPath defaults) {
