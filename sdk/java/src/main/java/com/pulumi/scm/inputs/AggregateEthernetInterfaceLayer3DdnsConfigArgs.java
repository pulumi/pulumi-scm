...
public final class AggregateEthernetInterfaceLayer3DdnsConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final AggregateEthernetInterfaceLayer3DdnsConfigArgs Empty = new AggregateEthernetInterfaceLayer3DdnsConfigArgs();
    ...
    private AggregateEthernetInterfaceLayer3DdnsConfigArgs() {}

    private AggregateEthernetInterfaceLayer3DdnsConfigArgs(AggregateEthernetInterfaceLayer3DdnsConfigArgs $) {
    ...
    public static Builder builder(AggregateEthernetInterfaceLayer3DdnsConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AggregateEthernetInterfaceLayer3DdnsConfigArgs();
        }

        public Builder(AggregateEthernetInterfaceLayer3DdnsConfigArgs defaults) {
            $ = new AggregateEthernetInterfaceLayer3DdnsConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AggregateEthernetInterfaceLayer3DdnsConfigArgs build() {
            return $;
        }
    }
