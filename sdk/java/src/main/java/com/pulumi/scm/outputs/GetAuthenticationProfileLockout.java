...
public final class GetAuthenticationProfileLockout {
    ...
    public static Builder builder(GetAuthenticationProfileLockout defaults) {
    ...
    public static final class Builder {
        ...
        private Integer lockoutTime;
        public Builder() {}
        public Builder(GetAuthenticationProfileLockout defaults) {
        ...
        public Builder failedAttempts(Integer failedAttempts) {
            if (failedAttempts == null) {
              throw new MissingRequiredPropertyException("GetAuthenticationProfileLockout", "failedAttempts");
            }
        ...
        public Builder lockoutTime(Integer lockoutTime) {
            if (lockoutTime == null) {
              throw new MissingRequiredPropertyException("GetAuthenticationProfileLockout", "lockoutTime");
            }
            this.lockoutTime = lockoutTime;
            return this;
        }
        public GetAuthenticationProfileLockout build() {
            final var _resultValue = new GetAuthenticationProfileLockout();
