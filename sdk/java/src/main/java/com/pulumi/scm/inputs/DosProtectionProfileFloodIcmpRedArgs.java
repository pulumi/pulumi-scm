...
import com.pulumi.scm.inputs.DosProtectionProfileFloodIcmpRedBlockArgs;
...
public final class DosProtectionProfileFloodIcmpRedArgs extends com.pulumi.resources.ResourceArgs {

    public static final DosProtectionProfileFloodIcmpRedArgs Empty = new DosProtectionProfileFloodIcmpRedArgs();
     ...
     */
    @Import(name="block")
    private @Nullable Output<DosProtectionProfileFloodIcmpRedBlockArgs> block;

    /**
     * @return Block
     * 
     */
    public Optional<Output<DosProtectionProfileFloodIcmpRedBlockArgs>> block() {
    ...
    private DosProtectionProfileFloodIcmpRedArgs() {}

    private DosProtectionProfileFloodIcmpRedArgs(DosProtectionProfileFloodIcmpRedArgs $) {
    ...
    public static Builder builder(DosProtectionProfileFloodIcmpRedArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DosProtectionProfileFloodIcmpRedArgs();
        }

        public Builder(DosProtectionProfileFloodIcmpRedArgs defaults) {
            $ = new DosProtectionProfileFloodIcmpRedArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder block(@Nullable Output<DosProtectionProfileFloodIcmpRedBlockArgs> block) {
            $.block = block;
            return this;
        }
         ...
         * 
         */
        public Builder block(DosProtectionProfileFloodIcmpRedBlockArgs block) {
        ...
        public DosProtectionProfileFloodIcmpRedArgs build() {
            return $;
        }
    }
