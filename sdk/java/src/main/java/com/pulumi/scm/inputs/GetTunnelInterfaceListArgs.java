...
public final class GetTunnelInterfaceListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTunnelInterfaceListArgs Empty = new GetTunnelInterfaceListArgs();
    ...
    private GetTunnelInterfaceListArgs() {}

    private GetTunnelInterfaceListArgs(GetTunnelInterfaceListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetTunnelInterfaceListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTunnelInterfaceListArgs();
        }

        public Builder(GetTunnelInterfaceListArgs defaults) {
            $ = new GetTunnelInterfaceListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTunnelInterfaceListArgs build() {
            return $;
        }
    }
