...
import com.pulumi.scm.outputs.EthernetInterfaceLayer3DhcpClientDhcpClientSendHostname;
...
@CustomType
public final class EthernetInterfaceLayer3DhcpClientDhcpClient {
    /**
     ...
     * 
     */
    private @Nullable EthernetInterfaceLayer3DhcpClientDhcpClientSendHostname sendHostname;

    private EthernetInterfaceLayer3DhcpClientDhcpClient() {}
    /**
     * @return Create default route
     * 
     */
     ...
     * 
     */
    public Optional<EthernetInterfaceLayer3DhcpClientDhcpClientSendHostname> sendHostname() {
    ...
    public static Builder builder(EthernetInterfaceLayer3DhcpClientDhcpClient defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable EthernetInterfaceLayer3DhcpClientDhcpClientSendHostname sendHostname;
        public Builder() {}
        public Builder(EthernetInterfaceLayer3DhcpClientDhcpClient defaults) {
        ...
        @CustomType.Setter
        public Builder sendHostname(@Nullable EthernetInterfaceLayer3DhcpClientDhcpClientSendHostname sendHostname) {

            this.sendHostname = sendHostname;
            return this;
        }
        public EthernetInterfaceLayer3DhcpClientDhcpClient build() {
            final var _resultValue = new EthernetInterfaceLayer3DhcpClientDhcpClient();
