...
@CustomType
public final class HipObjectMobileDeviceCriteriaImei {
    /**
    ...
    private HipObjectMobileDeviceCriteriaImei() {}
    /**
     * @return The Contains param. String length must not exceed 255 characters. Ensure that only one of the following is specified: `contains`, `is`, `is_not`
     * 
     */
    ...
    public static Builder builder(HipObjectMobileDeviceCriteriaImei defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String isNot;
        public Builder() {}
        public Builder(HipObjectMobileDeviceCriteriaImei defaults) {
        ...
        public HipObjectMobileDeviceCriteriaImei build() {
            final var _resultValue = new HipObjectMobileDeviceCriteriaImei();
