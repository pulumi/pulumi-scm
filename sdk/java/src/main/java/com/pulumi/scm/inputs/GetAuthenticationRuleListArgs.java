...
public final class GetAuthenticationRuleListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAuthenticationRuleListArgs Empty = new GetAuthenticationRuleListArgs();
    ...
    private GetAuthenticationRuleListArgs() {}

    private GetAuthenticationRuleListArgs(GetAuthenticationRuleListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetAuthenticationRuleListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAuthenticationRuleListArgs();
        }

        public Builder(GetAuthenticationRuleListArgs defaults) {
            $ = new GetAuthenticationRuleListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAuthenticationRuleListArgs build() {
            if ($.position == null) {
                throw new MissingRequiredPropertyException("GetAuthenticationRuleListArgs", "position");
            }
            return $;
        }
    }
