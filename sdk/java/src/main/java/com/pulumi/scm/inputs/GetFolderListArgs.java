...
public final class GetFolderListArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static Builder builder(GetFolderListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFolderListArgs();
        }

        public Builder(GetFolderListArgs defaults) {
            $ = new GetFolderListArgs(Objects.requireNonNull(defaults));
        }
