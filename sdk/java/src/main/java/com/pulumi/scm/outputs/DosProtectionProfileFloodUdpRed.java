...
import com.pulumi.scm.outputs.DosProtectionProfileFloodUdpRedBlock;
...
@CustomType
public final class DosProtectionProfileFloodUdpRed {
    /**
     ...
     * 
     */
    private @Nullable DosProtectionProfileFloodUdpRedBlock block;
    /**
     * @return Maximal rate
     * 
     */
    ...
    private DosProtectionProfileFloodUdpRed() {}
    /**
     * @return Activate rate
     * 
     */
     ...
     * 
     */
    public Optional<DosProtectionProfileFloodUdpRedBlock> block() {
    ...
    public static Builder builder(DosProtectionProfileFloodUdpRed defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer maximalRate;
        public Builder() {}
        public Builder(DosProtectionProfileFloodUdpRed defaults) {
        ...
        @CustomType.Setter
        public Builder block(@Nullable DosProtectionProfileFloodUdpRedBlock block) {
        ...
        public DosProtectionProfileFloodUdpRed build() {
            final var _resultValue = new DosProtectionProfileFloodUdpRed();
