...
public final class SecurityRuleAllowWebApplicationFileControlArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SecurityRuleAllowWebApplicationFileControlArgs() {}

    private SecurityRuleAllowWebApplicationFileControlArgs(SecurityRuleAllowWebApplicationFileControlArgs $) {
    ...
    public static Builder builder(SecurityRuleAllowWebApplicationFileControlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityRuleAllowWebApplicationFileControlArgs();
        }

        public Builder(SecurityRuleAllowWebApplicationFileControlArgs defaults) {
            $ = new SecurityRuleAllowWebApplicationFileControlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecurityRuleAllowWebApplicationFileControlArgs build() {
            return $;
        }
    }
