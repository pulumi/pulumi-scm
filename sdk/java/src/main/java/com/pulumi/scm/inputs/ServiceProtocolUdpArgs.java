...
import com.pulumi.scm.inputs.ServiceProtocolUdpOverrideArgs;
...
public final class ServiceProtocolUdpArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceProtocolUdpArgs() {}

    private ServiceProtocolUdpArgs(ServiceProtocolUdpArgs $) {
    ...
    public static Builder builder(ServiceProtocolUdpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceProtocolUdpArgs();
        }

        public Builder(ServiceProtocolUdpArgs defaults) {
            $ = new ServiceProtocolUdpArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder override(@Nullable Output<ServiceProtocolUdpOverrideArgs> override) {
            $.override = override;
            return this;
        }
         ...
         * 
         */
        public Builder override(ServiceProtocolUdpOverrideArgs override) {
        ...
        public ServiceProtocolUdpArgs build() {
            if ($.port == null) {
                throw new MissingRequiredPropertyException("ServiceProtocolUdpArgs", "port");
            }
            return $;
        }
    }
