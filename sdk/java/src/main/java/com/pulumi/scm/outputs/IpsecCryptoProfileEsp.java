...
public final class IpsecCryptoProfileEsp {
    ...
    public static Builder builder(IpsecCryptoProfileEsp defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> encryptions;
        public Builder() {}
        public Builder(IpsecCryptoProfileEsp defaults) {
        ...
        public Builder authentications(List<String> authentications) {
            if (authentications == null) {
              throw new MissingRequiredPropertyException("IpsecCryptoProfileEsp", "authentications");
            }
        ...
        public Builder encryptions(List<String> encryptions) {
            if (encryptions == null) {
              throw new MissingRequiredPropertyException("IpsecCryptoProfileEsp", "encryptions");
            }
        ...
        public IpsecCryptoProfileEsp build() {
            final var _resultValue = new IpsecCryptoProfileEsp();
