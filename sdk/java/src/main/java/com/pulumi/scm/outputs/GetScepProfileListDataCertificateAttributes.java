...
public final class GetScepProfileListDataCertificateAttributes {
    ...
    public static Builder builder(GetScepProfileListDataCertificateAttributes defaults) {
    ...
    public static final class Builder {
        ...
        private String uniformResourceIdentifier;
        public Builder() {}
        public Builder(GetScepProfileListDataCertificateAttributes defaults) {
        ...
        public Builder dnsname(String dnsname) {
            if (dnsname == null) {
              throw new MissingRequiredPropertyException("GetScepProfileListDataCertificateAttributes", "dnsname");
            }
        ...
        public Builder rfc822name(String rfc822name) {
            if (rfc822name == null) {
              throw new MissingRequiredPropertyException("GetScepProfileListDataCertificateAttributes", "rfc822name");
            }
        ...
        public Builder uniformResourceIdentifier(String uniformResourceIdentifier) {
            if (uniformResourceIdentifier == null) {
              throw new MissingRequiredPropertyException("GetScepProfileListDataCertificateAttributes", "uniformResourceIdentifier");
            }
            this.uniformResourceIdentifier = uniformResourceIdentifier;
            return this;
        }
        public GetScepProfileListDataCertificateAttributes build() {
            final var _resultValue = new GetScepProfileListDataCertificateAttributes();
