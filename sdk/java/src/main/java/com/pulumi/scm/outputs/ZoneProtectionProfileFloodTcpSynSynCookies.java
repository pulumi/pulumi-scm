...
@CustomType
public final class ZoneProtectionProfileFloodTcpSynSynCookies {
    /**
    ...
    private ZoneProtectionProfileFloodTcpSynSynCookies() {}
    /**
     * @return When the flow exceeds the `activateRate`` threshold, the firewall drops individual SYN packets randomly to restrict the flow.
     * 
     */
    ...
    public static Builder builder(ZoneProtectionProfileFloodTcpSynSynCookies defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maximalRate;
        public Builder() {}
        public Builder(ZoneProtectionProfileFloodTcpSynSynCookies defaults) {
        ...
        public Builder activateRate(Integer activateRate) {
            if (activateRate == null) {
              throw new MissingRequiredPropertyException("ZoneProtectionProfileFloodTcpSynSynCookies", "activateRate");
            }
        ...
        public Builder alarmRate(Integer alarmRate) {
            if (alarmRate == null) {
              throw new MissingRequiredPropertyException("ZoneProtectionProfileFloodTcpSynSynCookies", "alarmRate");
            }
        ...
        public Builder maximalRate(Integer maximalRate) {
            if (maximalRate == null) {
              throw new MissingRequiredPropertyException("ZoneProtectionProfileFloodTcpSynSynCookies", "maximalRate");
            }
            this.maximalRate = maximalRate;
            return this;
        }
        public ZoneProtectionProfileFloodTcpSynSynCookies build() {
            final var _resultValue = new ZoneProtectionProfileFloodTcpSynSynCookies();
