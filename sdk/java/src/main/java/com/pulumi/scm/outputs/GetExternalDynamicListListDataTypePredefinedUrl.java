...
public final class GetExternalDynamicListListDataTypePredefinedUrl {
    ...
    public static Builder builder(GetExternalDynamicListListDataTypePredefinedUrl defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(GetExternalDynamicListListDataTypePredefinedUrl defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetExternalDynamicListListDataTypePredefinedUrl", "description");
            }
        ...
        public Builder exceptionLists(List<String> exceptionLists) {
            if (exceptionLists == null) {
              throw new MissingRequiredPropertyException("GetExternalDynamicListListDataTypePredefinedUrl", "exceptionLists");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetExternalDynamicListListDataTypePredefinedUrl", "url");
            }
            this.url = url;
            return this;
        }
        public GetExternalDynamicListListDataTypePredefinedUrl build() {
            final var _resultValue = new GetExternalDynamicListListDataTypePredefinedUrl();
