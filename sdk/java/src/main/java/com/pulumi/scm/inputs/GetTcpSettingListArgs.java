...
public final class GetTcpSettingListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTcpSettingListArgs Empty = new GetTcpSettingListArgs();
    ...
    private GetTcpSettingListArgs() {}

    private GetTcpSettingListArgs(GetTcpSettingListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetTcpSettingListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTcpSettingListArgs();
        }

        public Builder(GetTcpSettingListArgs defaults) {
            $ = new GetTcpSettingListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTcpSettingListArgs build() {
            return $;
        }
    }
