...
public final class GetAntiSpywareSignatureResult {
    ...
    public static Builder builder(GetAntiSpywareSignatureResult defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> vendors;
        public Builder() {}
        public Builder(GetAntiSpywareSignatureResult defaults) {
        ...
        public Builder bugtraqs(List<String> bugtraqs) {
            if (bugtraqs == null) {
              throw new MissingRequiredPropertyException("GetAntiSpywareSignatureResult", "bugtraqs");
            }
        ...
        public Builder comment(String comment) {
            if (comment == null) {
              throw new MissingRequiredPropertyException("GetAntiSpywareSignatureResult", "comment");
            }
        ...
        public Builder cves(List<String> cves) {
            if (cves == null) {
              throw new MissingRequiredPropertyException("GetAntiSpywareSignatureResult", "cves");
            }
            this.cves = cves;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder defaultAction(GetAntiSpywareSignatureDefaultAction defaultAction) {
            if (defaultAction == null) {
              throw new MissingRequiredPropertyException("GetAntiSpywareSignatureResult", "defaultAction");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAntiSpywareSignatureResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder references(List<String> references) {
            if (references == null) {
              throw new MissingRequiredPropertyException("GetAntiSpywareSignatureResult", "references");
            }
        ...
        public Builder severity(String severity) {
            if (severity == null) {
              throw new MissingRequiredPropertyException("GetAntiSpywareSignatureResult", "severity");
            }
            this.severity = severity;
            return this;
        }
        @CustomType.Setter
        public Builder signature(GetAntiSpywareSignatureSignature signature) {
            if (signature == null) {
        ...
        public Builder tfid(String tfid) {
            if (tfid == null) {
              throw new MissingRequiredPropertyException("GetAntiSpywareSignatureResult", "tfid");
            }
            this.tfid = tfid;
            return this;
        }
        ...
        public Builder threatname(String threatname) {
            if (threatname == null) {
              throw new MissingRequiredPropertyException("GetAntiSpywareSignatureResult", "threatname");
            }
        ...
        public Builder vendors(List<String> vendors) {
            if (vendors == null) {
              throw new MissingRequiredPropertyException("GetAntiSpywareSignatureResult", "vendors");
            }
        ...
        public GetAntiSpywareSignatureResult build() {
            final var _resultValue = new GetAntiSpywareSignatureResult();
