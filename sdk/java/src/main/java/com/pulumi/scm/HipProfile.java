...
public class HipProfile extends com.pulumi.resources.CustomResource {
     ...
     */
    public HipProfile(String name, HipProfileArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("scm:index/hipProfile:HipProfile", name, args == null ? HipProfileArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private HipProfile(String name, Output<String> id, @Nullable HipProfileState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("scm:index/hipProfile:HipProfile", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static HipProfile get(String name, Output<String> id, @Nullable HipProfileState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
