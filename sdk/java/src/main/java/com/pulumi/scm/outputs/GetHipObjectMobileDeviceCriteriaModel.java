...
public final class GetHipObjectMobileDeviceCriteriaModel {
    ...
    public static Builder builder(GetHipObjectMobileDeviceCriteriaModel defaults) {
    ...
    public static final class Builder {
        ...
        private String isNot;
        public Builder() {}
        public Builder(GetHipObjectMobileDeviceCriteriaModel defaults) {
        ...
        public Builder contains(String contains) {
            if (contains == null) {
              throw new MissingRequiredPropertyException("GetHipObjectMobileDeviceCriteriaModel", "contains");
            }
        ...
        public Builder is(String is) {
            if (is == null) {
              throw new MissingRequiredPropertyException("GetHipObjectMobileDeviceCriteriaModel", "is");
            }
            this.is = is;
            return this;
        }
        ...
        public Builder isNot(String isNot) {
            if (isNot == null) {
              throw new MissingRequiredPropertyException("GetHipObjectMobileDeviceCriteriaModel", "isNot");
            }
            this.isNot = isNot;
            return this;
        }
        public GetHipObjectMobileDeviceCriteriaModel build() {
            final var _resultValue = new GetHipObjectMobileDeviceCriteriaModel();
