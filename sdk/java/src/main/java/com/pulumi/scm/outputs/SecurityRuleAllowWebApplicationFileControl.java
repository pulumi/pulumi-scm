...
public final class SecurityRuleAllowWebApplicationFileControl {
    ...
    public static Builder builder(SecurityRuleAllowWebApplicationFileControl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String upload;
        public Builder() {}
        public Builder(SecurityRuleAllowWebApplicationFileControl defaults) {
        ...
        public SecurityRuleAllowWebApplicationFileControl build() {
            final var _resultValue = new SecurityRuleAllowWebApplicationFileControl();
