...
public final class GetDataObjectListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDataObjectListArgs Empty = new GetDataObjectListArgs();
    ...
    private GetDataObjectListArgs() {}

    private GetDataObjectListArgs(GetDataObjectListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetDataObjectListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDataObjectListArgs();
        }

        public Builder(GetDataObjectListArgs defaults) {
            $ = new GetDataObjectListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDataObjectListArgs build() {
            return $;
        }
    }
