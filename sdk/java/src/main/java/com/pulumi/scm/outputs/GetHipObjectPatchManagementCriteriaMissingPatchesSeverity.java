...
public final class GetHipObjectPatchManagementCriteriaMissingPatchesSeverity {
    ...
    public static Builder builder(GetHipObjectPatchManagementCriteriaMissingPatchesSeverity defaults) {
    ...
    public static final class Builder {
        ...
        private Integer lessThan;
        public Builder() {}
        public Builder(GetHipObjectPatchManagementCriteriaMissingPatchesSeverity defaults) {
        ...
        public Builder greaterEqual(Integer greaterEqual) {
            if (greaterEqual == null) {
              throw new MissingRequiredPropertyException("GetHipObjectPatchManagementCriteriaMissingPatchesSeverity", "greaterEqual");
            }
        ...
        public Builder greaterThan(Integer greaterThan) {
            if (greaterThan == null) {
              throw new MissingRequiredPropertyException("GetHipObjectPatchManagementCriteriaMissingPatchesSeverity", "greaterThan");
            }
        ...
        public Builder is(Integer is) {
            if (is == null) {
              throw new MissingRequiredPropertyException("GetHipObjectPatchManagementCriteriaMissingPatchesSeverity", "is");
            }
            this.is = is;
            return this;
        }
        ...
        public Builder isNot(Integer isNot) {
            if (isNot == null) {
              throw new MissingRequiredPropertyException("GetHipObjectPatchManagementCriteriaMissingPatchesSeverity", "isNot");
            }
            this.isNot = isNot;
            return this;
        }
        ...
        public Builder lessEqual(Integer lessEqual) {
            if (lessEqual == null) {
              throw new MissingRequiredPropertyException("GetHipObjectPatchManagementCriteriaMissingPatchesSeverity", "lessEqual");
            }
        ...
        public Builder lessThan(Integer lessThan) {
            if (lessThan == null) {
              throw new MissingRequiredPropertyException("GetHipObjectPatchManagementCriteriaMissingPatchesSeverity", "lessThan");
            }
            this.lessThan = lessThan;
            return this;
        }
        public GetHipObjectPatchManagementCriteriaMissingPatchesSeverity build() {
            final var _resultValue = new GetHipObjectPatchManagementCriteriaMissingPatchesSeverity();
