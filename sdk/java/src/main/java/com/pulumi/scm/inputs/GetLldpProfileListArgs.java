...
public final class GetLldpProfileListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLldpProfileListArgs Empty = new GetLldpProfileListArgs();
    ...
    private GetLldpProfileListArgs() {}

    private GetLldpProfileListArgs(GetLldpProfileListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetLldpProfileListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLldpProfileListArgs();
        }

        public Builder(GetLldpProfileListArgs defaults) {
            $ = new GetLldpProfileListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLldpProfileListArgs build() {
            return $;
        }
    }
