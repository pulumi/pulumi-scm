...
public final class GetSessionSettingListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSessionSettingListArgs Empty = new GetSessionSettingListArgs();
    ...
    private GetSessionSettingListArgs() {}

    private GetSessionSettingListArgs(GetSessionSettingListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetSessionSettingListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSessionSettingListArgs();
        }

        public Builder(GetSessionSettingListArgs defaults) {
            $ = new GetSessionSettingListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSessionSettingListArgs build() {
            return $;
        }
    }
