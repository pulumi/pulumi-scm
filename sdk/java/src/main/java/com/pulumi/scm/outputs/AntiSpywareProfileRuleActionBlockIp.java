...
@CustomType
public final class AntiSpywareProfileRuleActionBlockIp {
    /**
    ...
    public static Builder builder(AntiSpywareProfileRuleActionBlockIp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String trackBy;
        public Builder() {}
        public Builder(AntiSpywareProfileRuleActionBlockIp defaults) {
        ...
        public AntiSpywareProfileRuleActionBlockIp build() {
            final var _resultValue = new AntiSpywareProfileRuleActionBlockIp();
