...
@CustomType
public final class HipObjectDataLossPreventionVendor {
    /**
    ...
    private HipObjectDataLossPreventionVendor() {}
    /**
     * @return The Name param. String length must not exceed 103 characters.
     * 
     */
    ...
    public static Builder builder(HipObjectDataLossPreventionVendor defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> products;
        public Builder() {}
        public Builder(HipObjectDataLossPreventionVendor defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("HipObjectDataLossPreventionVendor", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public HipObjectDataLossPreventionVendor build() {
            final var _resultValue = new HipObjectDataLossPreventionVendor();
