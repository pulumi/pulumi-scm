...
import com.pulumi.scm.outputs.GetZoneNetworkTunnel;
...
public final class GetZoneNetwork {
     ...
     * 
     */
    private GetZoneNetworkTunnel tunnel;
    /**
     * @return Virtual wire
     * 
     */
     ...
     * 
     */
    public GetZoneNetworkTunnel tunnel() {
        return this.tunnel;
    }
    /**
     * @return Virtual wire
    ...
    public static final class Builder {
        ...
        public Builder externals(List<String> externals) {
            if (externals == null) {
              throw new MissingRequiredPropertyException("GetZoneNetwork", "externals");
            }
        ...
        public Builder layer2s(List<String> layer2s) {
            if (layer2s == null) {
              throw new MissingRequiredPropertyException("GetZoneNetwork", "layer2s");
            }
        ...
        public Builder layer3s(List<String> layer3s) {
            if (layer3s == null) {
              throw new MissingRequiredPropertyException("GetZoneNetwork", "layer3s");
            }
        ...
        public Builder taps(List<String> taps) {
            if (taps == null) {
              throw new MissingRequiredPropertyException("GetZoneNetwork", "taps");
            }
            this.taps = taps;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder tunnel(GetZoneNetworkTunnel tunnel) {
            if (tunnel == null) {
              throw new MissingRequiredPropertyException("GetZoneNetwork", "tunnel");
            }
            this.tunnel = tunnel;
            return this;
        }
        ...
        public Builder virtualWires(List<String> virtualWires) {
            if (virtualWires == null) {
              throw new MissingRequiredPropertyException("GetZoneNetwork", "virtualWires");
            }
