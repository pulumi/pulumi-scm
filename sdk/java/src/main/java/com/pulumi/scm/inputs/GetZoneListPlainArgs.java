...
public final class GetZoneListPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetZoneListPlainArgs Empty = new GetZoneListPlainArgs();
    ...
    private GetZoneListPlainArgs() {}

    private GetZoneListPlainArgs(GetZoneListPlainArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetZoneListPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetZoneListPlainArgs();
        }

        public Builder(GetZoneListPlainArgs defaults) {
            $ = new GetZoneListPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetZoneListPlainArgs build() {
            return $;
        }
    }
