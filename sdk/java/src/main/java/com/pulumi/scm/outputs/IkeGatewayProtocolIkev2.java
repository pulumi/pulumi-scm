...
import com.pulumi.scm.outputs.IkeGatewayProtocolIkev2Dpd;
...
public final class IkeGatewayProtocolIkev2 {
    ...
    public static Builder builder(IkeGatewayProtocolIkev2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String ikeCryptoProfile;
        public Builder() {}
        public Builder(IkeGatewayProtocolIkev2 defaults) {
        ...
        @CustomType.Setter
        public Builder dpd(@Nullable IkeGatewayProtocolIkev2Dpd dpd) {
        ...
        public IkeGatewayProtocolIkev2 build() {
            final var _resultValue = new IkeGatewayProtocolIkev2();
