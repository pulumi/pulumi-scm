...
public final class GetAuthenticationProfileListDataMultiFactorAuth {
    ...
    public static Builder builder(GetAuthenticationProfileListDataMultiFactorAuth defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean mfaEnable;
        public Builder() {}
        public Builder(GetAuthenticationProfileListDataMultiFactorAuth defaults) {
        ...
        public Builder factors(List<String> factors) {
            if (factors == null) {
              throw new MissingRequiredPropertyException("GetAuthenticationProfileListDataMultiFactorAuth", "factors");
            }
        ...
        public Builder mfaEnable(Boolean mfaEnable) {
            if (mfaEnable == null) {
              throw new MissingRequiredPropertyException("GetAuthenticationProfileListDataMultiFactorAuth", "mfaEnable");
            }
            this.mfaEnable = mfaEnable;
            return this;
        }
        public GetAuthenticationProfileListDataMultiFactorAuth build() {
            final var _resultValue = new GetAuthenticationProfileListDataMultiFactorAuth();
