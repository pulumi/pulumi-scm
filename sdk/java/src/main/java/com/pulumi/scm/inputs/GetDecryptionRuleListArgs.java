...
public final class GetDecryptionRuleListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDecryptionRuleListArgs Empty = new GetDecryptionRuleListArgs();
    ...
    private GetDecryptionRuleListArgs() {}

    private GetDecryptionRuleListArgs(GetDecryptionRuleListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetDecryptionRuleListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDecryptionRuleListArgs();
        }

        public Builder(GetDecryptionRuleListArgs defaults) {
            $ = new GetDecryptionRuleListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDecryptionRuleListArgs build() {
            if ($.position == null) {
                throw new MissingRequiredPropertyException("GetDecryptionRuleListArgs", "position");
            }
            return $;
        }
    }
