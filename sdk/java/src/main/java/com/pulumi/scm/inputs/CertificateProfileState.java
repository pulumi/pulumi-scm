...
public final class CertificateProfileState extends com.pulumi.resources.ResourceArgs {

    public static final CertificateProfileState Empty = new CertificateProfileState();
    ...
    private @Nullable Output<List<CertificateProfileCaCertificateArgs>> caCertificates;

    /**
     * @return The CaCertificates param.
     * 
     */
    public Optional<Output<List<CertificateProfileCaCertificateArgs>>> caCertificates() {
    ...
    private CertificateProfileState() {}

    private CertificateProfileState(CertificateProfileState $) {
    ...
    public static Builder builder(CertificateProfileState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CertificateProfileState();
        }

        public Builder(CertificateProfileState defaults) {
            $ = new CertificateProfileState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder caCertificates(@Nullable Output<List<CertificateProfileCaCertificateArgs>> caCertificates) {
        ...
        public CertificateProfileState build() {
            return $;
        }
    }
