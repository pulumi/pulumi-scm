...
public final class GetServiceRouteListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceRouteListArgs Empty = new GetServiceRouteListArgs();
    ...
    private GetServiceRouteListArgs() {}

    private GetServiceRouteListArgs(GetServiceRouteListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetServiceRouteListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceRouteListArgs();
        }

        public Builder(GetServiceRouteListArgs defaults) {
            $ = new GetServiceRouteListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceRouteListArgs build() {
            return $;
        }
    }
