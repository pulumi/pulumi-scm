...
import com.pulumi.scm.outputs.GetServiceListData;
...
public final class GetServiceListResult {
     ...
     * 
     */
    private List<GetServiceListData> datas;
    /**
     ...
     * 
     */
    public List<GetServiceListData> datas() {
        return this.datas;
    }
    /**
     * @return The Device param.
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder datas(List<GetServiceListData> datas) {
            if (datas == null) {
              throw new MissingRequiredPropertyException("GetServiceListResult", "datas");
            }
            this.datas = datas;
            return this;
        }
        public Builder datas(GetServiceListData... datas) {
        ...
        public Builder limit(Integer limit) {
            if (limit == null) {
              throw new MissingRequiredPropertyException("GetServiceListResult", "limit");
            }
            this.limit = limit;
            return this;
        }
        ...
        public Builder offset(Integer offset) {
            if (offset == null) {
              throw new MissingRequiredPropertyException("GetServiceListResult", "offset");
            }
            this.offset = offset;
            return this;
        }
        ...
        public Builder tfid(String tfid) {
            if (tfid == null) {
              throw new MissingRequiredPropertyException("GetServiceListResult", "tfid");
            }
            this.tfid = tfid;
            return this;
        }
        ...
        public Builder total(Integer total) {
            if (total == null) {
              throw new MissingRequiredPropertyException("GetServiceListResult", "total");
            }
            this.total = total;
            return this;
        }
