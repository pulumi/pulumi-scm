...
public final class GetHipObjectListDataDiskBackupVendor {
    ...
    public static Builder builder(GetHipObjectListDataDiskBackupVendor defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> products;
        public Builder() {}
        public Builder(GetHipObjectListDataDiskBackupVendor defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetHipObjectListDataDiskBackupVendor", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder products(List<String> products) {
            if (products == null) {
              throw new MissingRequiredPropertyException("GetHipObjectListDataDiskBackupVendor", "products");
            }
        ...
        public GetHipObjectListDataDiskBackupVendor build() {
            final var _resultValue = new GetHipObjectListDataDiskBackupVendor();
