...
public final class UrlCategoryState extends com.pulumi.resources.ResourceArgs {
    ...
    private UrlCategoryState() {}

    private UrlCategoryState(UrlCategoryState $) {
    ...
    public static Builder builder(UrlCategoryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UrlCategoryState();
        }

        public Builder(UrlCategoryState defaults) {
            $ = new UrlCategoryState(Objects.requireNonNull(defaults));
        }
