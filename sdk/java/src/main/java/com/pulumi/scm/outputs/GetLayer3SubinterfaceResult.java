...
public final class GetLayer3SubinterfaceResult {
    ...
    public static Builder builder(GetLayer3SubinterfaceResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder arps(List<GetLayer3SubinterfaceArp> arps) {
            if (arps == null) {
              throw new MissingRequiredPropertyException("GetLayer3SubinterfaceResult", "arps");
            }
            this.arps = arps;
            return this;
        }
        public Builder arps(GetLayer3SubinterfaceArp... arps) {
            return arps(List.of(arps));
        }
        @CustomType.Setter
        public Builder comment(String comment) {
            if (comment == null) {
              throw new MissingRequiredPropertyException("GetLayer3SubinterfaceResult", "comment");
            }
            this.comment = comment;
            return this;
        }
        @CustomType.Setter
        public Builder ddnsConfig(GetLayer3SubinterfaceDdnsConfig ddnsConfig) {
            if (ddnsConfig == null) {
              throw new MissingRequiredPropertyException("GetLayer3SubinterfaceResult", "ddnsConfig");
            }
        ...
        public Builder device(String device) {
            if (device == null) {
              throw new MissingRequiredPropertyException("GetLayer3SubinterfaceResult", "device");
            }
            this.device = device;
            return this;
        }
        @CustomType.Setter
        public Builder dhcpClient(GetLayer3SubinterfaceDhcpClient dhcpClient) {
            if (dhcpClient == null) {
        ...
        public Builder folder(String folder) {
            if (folder == null) {
              throw new MissingRequiredPropertyException("GetLayer3SubinterfaceResult", "folder");
            }
            this.folder = folder;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetLayer3SubinterfaceResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder interfaceManagementProfile(String interfaceManagementProfile) {
            if (interfaceManagementProfile == null) {
              throw new MissingRequiredPropertyException("GetLayer3SubinterfaceResult", "interfaceManagementProfile");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetLayer3SubinterfaceResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder tfid(String tfid) {
            if (tfid == null) {
              throw new MissingRequiredPropertyException("GetLayer3SubinterfaceResult", "tfid");
            }
            this.tfid = tfid;
            return this;
        }
