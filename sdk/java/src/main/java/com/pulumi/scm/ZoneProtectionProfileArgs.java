...
public final class ZoneProtectionProfileArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZoneProtectionProfileArgs Empty = new ZoneProtectionProfileArgs();
    ...
    private ZoneProtectionProfileArgs() {}

    private ZoneProtectionProfileArgs(ZoneProtectionProfileArgs $) {
    ...
    public static Builder builder(ZoneProtectionProfileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZoneProtectionProfileArgs();
        }

        public Builder(ZoneProtectionProfileArgs defaults) {
            $ = new ZoneProtectionProfileArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ZoneProtectionProfileArgs build() {
            return $;
        }
    }
