...
public final class HipObjectHostInfoCriteriaDomainArgs extends com.pulumi.resources.ResourceArgs {

    public static final HipObjectHostInfoCriteriaDomainArgs Empty = new HipObjectHostInfoCriteriaDomainArgs();
    ...
    private HipObjectHostInfoCriteriaDomainArgs() {}

    private HipObjectHostInfoCriteriaDomainArgs(HipObjectHostInfoCriteriaDomainArgs $) {
    ...
    public static Builder builder(HipObjectHostInfoCriteriaDomainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HipObjectHostInfoCriteriaDomainArgs();
        }

        public Builder(HipObjectHostInfoCriteriaDomainArgs defaults) {
            $ = new HipObjectHostInfoCriteriaDomainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HipObjectHostInfoCriteriaDomainArgs build() {
            return $;
        }
    }
