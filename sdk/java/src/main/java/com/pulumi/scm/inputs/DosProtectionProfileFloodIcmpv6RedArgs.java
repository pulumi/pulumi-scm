...
import com.pulumi.scm.inputs.DosProtectionProfileFloodIcmpv6RedBlockArgs;
...
public final class DosProtectionProfileFloodIcmpv6RedArgs extends com.pulumi.resources.ResourceArgs {

    public static final DosProtectionProfileFloodIcmpv6RedArgs Empty = new DosProtectionProfileFloodIcmpv6RedArgs();
     ...
     */
    @Import(name="block")
    private @Nullable Output<DosProtectionProfileFloodIcmpv6RedBlockArgs> block;

    /**
     * @return Block
     * 
     */
    public Optional<Output<DosProtectionProfileFloodIcmpv6RedBlockArgs>> block() {
    ...
    private DosProtectionProfileFloodIcmpv6RedArgs() {}

    private DosProtectionProfileFloodIcmpv6RedArgs(DosProtectionProfileFloodIcmpv6RedArgs $) {
    ...
    public static Builder builder(DosProtectionProfileFloodIcmpv6RedArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DosProtectionProfileFloodIcmpv6RedArgs();
        }

        public Builder(DosProtectionProfileFloodIcmpv6RedArgs defaults) {
            $ = new DosProtectionProfileFloodIcmpv6RedArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder block(@Nullable Output<DosProtectionProfileFloodIcmpv6RedBlockArgs> block) {
            $.block = block;
            return this;
        }
         ...
         * 
         */
        public Builder block(DosProtectionProfileFloodIcmpv6RedBlockArgs block) {
        ...
        public DosProtectionProfileFloodIcmpv6RedArgs build() {
            return $;
        }
    }
