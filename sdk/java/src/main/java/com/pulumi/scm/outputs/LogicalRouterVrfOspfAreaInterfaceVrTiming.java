...
@CustomType
public final class LogicalRouterVrfOspfAreaInterfaceVrTiming {
    /**
     * @return Dead counts
     * 
     */
    ...
    public static Builder builder(LogicalRouterVrfOspfAreaInterfaceVrTiming defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer transitDelay;
        public Builder() {}
        public Builder(LogicalRouterVrfOspfAreaInterfaceVrTiming defaults) {
        ...
        public LogicalRouterVrfOspfAreaInterfaceVrTiming build() {
            final var _resultValue = new LogicalRouterVrfOspfAreaInterfaceVrTiming();
