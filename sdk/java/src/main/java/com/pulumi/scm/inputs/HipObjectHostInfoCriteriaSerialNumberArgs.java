...
public final class HipObjectHostInfoCriteriaSerialNumberArgs extends com.pulumi.resources.ResourceArgs {

    public static final HipObjectHostInfoCriteriaSerialNumberArgs Empty = new HipObjectHostInfoCriteriaSerialNumberArgs();
    ...
    private HipObjectHostInfoCriteriaSerialNumberArgs() {}

    private HipObjectHostInfoCriteriaSerialNumberArgs(HipObjectHostInfoCriteriaSerialNumberArgs $) {
    ...
    public static Builder builder(HipObjectHostInfoCriteriaSerialNumberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HipObjectHostInfoCriteriaSerialNumberArgs();
        }

        public Builder(HipObjectHostInfoCriteriaSerialNumberArgs defaults) {
            $ = new HipObjectHostInfoCriteriaSerialNumberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HipObjectHostInfoCriteriaSerialNumberArgs build() {
            return $;
        }
    }
