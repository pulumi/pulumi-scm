...
@CustomType
public final class GetZoneProtectionProfileFloodTcpSynRed {
    /**
    ...
    private GetZoneProtectionProfileFloodTcpSynRed() {}
    /**
     * @return When the flow exceeds the `activateRate`` threshold, the firewall drops individual SYN packets randomly to restrict the flow.
     * 
     */
    ...
    public static Builder builder(GetZoneProtectionProfileFloodTcpSynRed defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maximalRate;
        public Builder() {}
        public Builder(GetZoneProtectionProfileFloodTcpSynRed defaults) {
        ...
        public Builder activateRate(Integer activateRate) {
            if (activateRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileFloodTcpSynRed", "activateRate");
            }
        ...
        public Builder alarmRate(Integer alarmRate) {
            if (alarmRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileFloodTcpSynRed", "alarmRate");
            }
        ...
        public Builder maximalRate(Integer maximalRate) {
            if (maximalRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileFloodTcpSynRed", "maximalRate");
            }
            this.maximalRate = maximalRate;
            return this;
        }
        public GetZoneProtectionProfileFloodTcpSynRed build() {
            final var _resultValue = new GetZoneProtectionProfileFloodTcpSynRed();
