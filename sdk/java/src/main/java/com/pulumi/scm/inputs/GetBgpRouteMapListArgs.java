...
public final class GetBgpRouteMapListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetBgpRouteMapListArgs Empty = new GetBgpRouteMapListArgs();
    ...
    private GetBgpRouteMapListArgs() {}

    private GetBgpRouteMapListArgs(GetBgpRouteMapListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetBgpRouteMapListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBgpRouteMapListArgs();
        }

        public Builder(GetBgpRouteMapListArgs defaults) {
            $ = new GetBgpRouteMapListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetBgpRouteMapListArgs build() {
            return $;
        }
    }
