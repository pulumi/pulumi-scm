...
@CustomType
public final class ZoneProtectionProfileFloodTcpSynRed {
    /**
    ...
    private ZoneProtectionProfileFloodTcpSynRed() {}
    /**
     * @return When the flow exceeds the `activateRate`` threshold, the firewall drops individual SYN packets randomly to restrict the flow.
     * 
     */
    ...
    public static Builder builder(ZoneProtectionProfileFloodTcpSynRed defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maximalRate;
        public Builder() {}
        public Builder(ZoneProtectionProfileFloodTcpSynRed defaults) {
        ...
        public Builder activateRate(Integer activateRate) {
            if (activateRate == null) {
              throw new MissingRequiredPropertyException("ZoneProtectionProfileFloodTcpSynRed", "activateRate");
            }
        ...
        public Builder alarmRate(Integer alarmRate) {
            if (alarmRate == null) {
              throw new MissingRequiredPropertyException("ZoneProtectionProfileFloodTcpSynRed", "alarmRate");
            }
        ...
        public Builder maximalRate(Integer maximalRate) {
            if (maximalRate == null) {
              throw new MissingRequiredPropertyException("ZoneProtectionProfileFloodTcpSynRed", "maximalRate");
            }
            this.maximalRate = maximalRate;
            return this;
        }
        public ZoneProtectionProfileFloodTcpSynRed build() {
            final var _resultValue = new ZoneProtectionProfileFloodTcpSynRed();
