...
@CustomType
public final class GetIpsecCryptoProfileEsp {
    /**
    ...
    private GetIpsecCryptoProfileEsp() {}
    /**
     * @return Authentication algorithm.
     * 
     */
    ...
    public static Builder builder(GetIpsecCryptoProfileEsp defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> encryptions;
        public Builder() {}
        public Builder(GetIpsecCryptoProfileEsp defaults) {
        ...
        public Builder authentications(List<String> authentications) {
            if (authentications == null) {
              throw new MissingRequiredPropertyException("GetIpsecCryptoProfileEsp", "authentications");
            }
        ...
        public Builder encryptions(List<String> encryptions) {
            if (encryptions == null) {
              throw new MissingRequiredPropertyException("GetIpsecCryptoProfileEsp", "encryptions");
            }
        ...
        public GetIpsecCryptoProfileEsp build() {
            final var _resultValue = new GetIpsecCryptoProfileEsp();
