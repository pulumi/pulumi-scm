...
public final class GetUseridMatchListListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetUseridMatchListListArgs Empty = new GetUseridMatchListListArgs();
    ...
    private GetUseridMatchListListArgs() {}

    private GetUseridMatchListListArgs(GetUseridMatchListListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetUseridMatchListListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetUseridMatchListListArgs();
        }

        public Builder(GetUseridMatchListListArgs defaults) {
            $ = new GetUseridMatchListListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetUseridMatchListListArgs build() {
            return $;
        }
    }
