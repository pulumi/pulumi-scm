...
public final class GetLinkTagListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLinkTagListArgs Empty = new GetLinkTagListArgs();
    ...
    private GetLinkTagListArgs() {}

    private GetLinkTagListArgs(GetLinkTagListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetLinkTagListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLinkTagListArgs();
        }

        public Builder(GetLinkTagListArgs defaults) {
            $ = new GetLinkTagListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLinkTagListArgs build() {
            return $;
        }
    }
