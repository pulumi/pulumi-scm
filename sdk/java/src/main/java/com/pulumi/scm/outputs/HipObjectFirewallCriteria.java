...
public final class HipObjectFirewallCriteria {
    ...
    public static Builder builder(HipObjectFirewallCriteria defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean isInstalled;
        public Builder() {}
        public Builder(HipObjectFirewallCriteria defaults) {
        ...
        public HipObjectFirewallCriteria build() {
            final var _resultValue = new HipObjectFirewallCriteria();
