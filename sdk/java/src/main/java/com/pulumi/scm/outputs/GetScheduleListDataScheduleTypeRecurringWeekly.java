...
public final class GetScheduleListDataScheduleTypeRecurringWeekly {
    ...
    public static final class Builder {
        ...
        public Builder fridays(List<String> fridays) {
            if (fridays == null) {
              throw new MissingRequiredPropertyException("GetScheduleListDataScheduleTypeRecurringWeekly", "fridays");
            }
        ...
        public Builder mondays(List<String> mondays) {
            if (mondays == null) {
              throw new MissingRequiredPropertyException("GetScheduleListDataScheduleTypeRecurringWeekly", "mondays");
            }
        ...
        public Builder saturdays(List<String> saturdays) {
            if (saturdays == null) {
              throw new MissingRequiredPropertyException("GetScheduleListDataScheduleTypeRecurringWeekly", "saturdays");
            }
        ...
        public Builder sundays(List<String> sundays) {
            if (sundays == null) {
              throw new MissingRequiredPropertyException("GetScheduleListDataScheduleTypeRecurringWeekly", "sundays");
            }
        ...
        public Builder thursdays(List<String> thursdays) {
            if (thursdays == null) {
              throw new MissingRequiredPropertyException("GetScheduleListDataScheduleTypeRecurringWeekly", "thursdays");
            }
        ...
        public Builder tuesdays(List<String> tuesdays) {
            if (tuesdays == null) {
              throw new MissingRequiredPropertyException("GetScheduleListDataScheduleTypeRecurringWeekly", "tuesdays");
            }
        ...
        public Builder wednesdays(List<String> wednesdays) {
            if (wednesdays == null) {
              throw new MissingRequiredPropertyException("GetScheduleListDataScheduleTypeRecurringWeekly", "wednesdays");
            }
