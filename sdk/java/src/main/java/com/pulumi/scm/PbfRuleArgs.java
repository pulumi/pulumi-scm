...
public final class PbfRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PbfRuleArgs Empty = new PbfRuleArgs();
    ...
    private PbfRuleArgs(PbfRuleArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(PbfRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PbfRuleArgs defaults) {
            $ = new PbfRuleArgs(Objects.requireNonNull(defaults));
        }
