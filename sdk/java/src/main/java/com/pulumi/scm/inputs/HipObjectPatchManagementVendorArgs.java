...
public final class HipObjectPatchManagementVendorArgs extends com.pulumi.resources.ResourceArgs {

    public static final HipObjectPatchManagementVendorArgs Empty = new HipObjectPatchManagementVendorArgs();
    ...
    private HipObjectPatchManagementVendorArgs() {}

    private HipObjectPatchManagementVendorArgs(HipObjectPatchManagementVendorArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(HipObjectPatchManagementVendorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HipObjectPatchManagementVendorArgs();
        }

        public Builder(HipObjectPatchManagementVendorArgs defaults) {
            $ = new HipObjectPatchManagementVendorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HipObjectPatchManagementVendorArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("HipObjectPatchManagementVendorArgs", "name");
            }
            return $;
        }
    }
