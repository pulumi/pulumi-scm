...
public final class IpsecTunnelAutoKeyProxyIdProtocolTcpArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpsecTunnelAutoKeyProxyIdProtocolTcpArgs Empty = new IpsecTunnelAutoKeyProxyIdProtocolTcpArgs();
    ...
    private IpsecTunnelAutoKeyProxyIdProtocolTcpArgs() {}

    private IpsecTunnelAutoKeyProxyIdProtocolTcpArgs(IpsecTunnelAutoKeyProxyIdProtocolTcpArgs $) {
    ...
    public static Builder builder(IpsecTunnelAutoKeyProxyIdProtocolTcpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpsecTunnelAutoKeyProxyIdProtocolTcpArgs();
        }

        public Builder(IpsecTunnelAutoKeyProxyIdProtocolTcpArgs defaults) {
            $ = new IpsecTunnelAutoKeyProxyIdProtocolTcpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IpsecTunnelAutoKeyProxyIdProtocolTcpArgs build() {
            return $;
        }
    }
