...
import com.pulumi.scm.inputs.DosProtectionProfileFloodTcpSynRedBlockArgs;
...
public final class DosProtectionProfileFloodTcpSynRedArgs extends com.pulumi.resources.ResourceArgs {

    public static final DosProtectionProfileFloodTcpSynRedArgs Empty = new DosProtectionProfileFloodTcpSynRedArgs();
     ...
     */
    @Import(name="block")
    private @Nullable Output<DosProtectionProfileFloodTcpSynRedBlockArgs> block;

    /**
     * @return Block
     * 
     */
    public Optional<Output<DosProtectionProfileFloodTcpSynRedBlockArgs>> block() {
    ...
    private DosProtectionProfileFloodTcpSynRedArgs() {}

    private DosProtectionProfileFloodTcpSynRedArgs(DosProtectionProfileFloodTcpSynRedArgs $) {
    ...
    public static Builder builder(DosProtectionProfileFloodTcpSynRedArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DosProtectionProfileFloodTcpSynRedArgs();
        }

        public Builder(DosProtectionProfileFloodTcpSynRedArgs defaults) {
            $ = new DosProtectionProfileFloodTcpSynRedArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder block(@Nullable Output<DosProtectionProfileFloodTcpSynRedBlockArgs> block) {
            $.block = block;
            return this;
        }
         ...
         * 
         */
        public Builder block(DosProtectionProfileFloodTcpSynRedBlockArgs block) {
        ...
        public DosProtectionProfileFloodTcpSynRedArgs build() {
            return $;
        }
    }
