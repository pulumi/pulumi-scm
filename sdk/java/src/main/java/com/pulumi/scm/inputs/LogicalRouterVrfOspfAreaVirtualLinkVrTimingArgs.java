...
public final class LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs extends com.pulumi.resources.ResourceArgs {

    public static final LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs Empty = new LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs();
    ...
    private LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs() {}

    private LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs(LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs $) {
    ...
    public static Builder builder(LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs();
        }

        public Builder(LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs defaults) {
            $ = new LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LogicalRouterVrfOspfAreaVirtualLinkVrTimingArgs build() {
            return $;
        }
    }
