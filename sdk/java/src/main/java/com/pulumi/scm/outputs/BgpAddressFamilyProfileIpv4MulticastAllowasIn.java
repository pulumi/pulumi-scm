...
import com.pulumi.scm.outputs.BgpAddressFamilyProfileIpv4MulticastAllowasInOrigin;
...
public final class BgpAddressFamilyProfileIpv4MulticastAllowasIn {
    ...
    public static Builder builder(BgpAddressFamilyProfileIpv4MulticastAllowasIn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable BgpAddressFamilyProfileIpv4MulticastAllowasInOrigin origin;
        public Builder() {}
        public Builder(BgpAddressFamilyProfileIpv4MulticastAllowasIn defaults) {
        ...
        @CustomType.Setter
        public Builder origin(@Nullable BgpAddressFamilyProfileIpv4MulticastAllowasInOrigin origin) {

            this.origin = origin;
            return this;
        }
        public BgpAddressFamilyProfileIpv4MulticastAllowasIn build() {
            final var _resultValue = new BgpAddressFamilyProfileIpv4MulticastAllowasIn();
