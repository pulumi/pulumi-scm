...
import com.pulumi.scm.outputs.ApplicationSignatureAndCondition;
...
public final class ApplicationSignature {
     ...
     * 
     */
    private @Nullable List<ApplicationSignatureAndCondition> andConditions;
    /**
     ...
     * 
     */
    public List<ApplicationSignatureAndCondition> andConditions() {
    ...
    public static Builder builder(ApplicationSignature defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String scope;
        public Builder() {}
        public Builder(ApplicationSignature defaults) {
        ...
        @CustomType.Setter
        public Builder andConditions(@Nullable List<ApplicationSignatureAndCondition> andConditions) {

            this.andConditions = andConditions;
            return this;
        }
        public Builder andConditions(ApplicationSignatureAndCondition... andConditions) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ApplicationSignature", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public ApplicationSignature build() {
            final var _resultValue = new ApplicationSignature();
