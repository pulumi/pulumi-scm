...
import com.pulumi.scm.outputs.DosProtectionProfileFloodIcmpv6RedBlock;
...
@CustomType
public final class DosProtectionProfileFloodIcmpv6Red {
    /**
     ...
     * 
     */
    private @Nullable DosProtectionProfileFloodIcmpv6RedBlock block;
    /**
     * @return Maximal rate
     * 
     */
     ...
     * 
     */
    public Optional<DosProtectionProfileFloodIcmpv6RedBlock> block() {
    ...
    public static Builder builder(DosProtectionProfileFloodIcmpv6Red defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer maximalRate;
        public Builder() {}
        public Builder(DosProtectionProfileFloodIcmpv6Red defaults) {
        ...
        @CustomType.Setter
        public Builder block(@Nullable DosProtectionProfileFloodIcmpv6RedBlock block) {
        ...
        public DosProtectionProfileFloodIcmpv6Red build() {
            final var _resultValue = new DosProtectionProfileFloodIcmpv6Red();
