...
public final class GetLogicalRouterListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLogicalRouterListArgs Empty = new GetLogicalRouterListArgs();
    ...
    private GetLogicalRouterListArgs() {}

    private GetLogicalRouterListArgs(GetLogicalRouterListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetLogicalRouterListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLogicalRouterListArgs();
        }

        public Builder(GetLogicalRouterListArgs defaults) {
            $ = new GetLogicalRouterListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLogicalRouterListArgs build() {
            return $;
        }
    }
