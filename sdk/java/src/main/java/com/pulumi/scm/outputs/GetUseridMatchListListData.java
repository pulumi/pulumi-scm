...
@CustomType
public final class GetUseridMatchListListData {
    /**
    ...
    private GetUseridMatchListListData() {}
    /**
     * @return Description of the userid match list entry
     * 
     */
    ...
    public static Builder builder(GetUseridMatchListListData defaults) {
    ...
    public static final class Builder {
        ...
        private String tfid;
        public Builder() {}
        public Builder(GetUseridMatchListListData defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "description");
            }
        ...
        public Builder device(String device) {
            if (device == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "device");
            }
            this.device = device;
            return this;
        }
        ...
        public Builder filter(String filter) {
            if (filter == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "filter");
            }
            this.filter = filter;
            return this;
        }
        ...
        public Builder folder(String folder) {
            if (folder == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "folder");
            }
            this.folder = folder;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder quarantine(Boolean quarantine) {
            if (quarantine == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "quarantine");
            }
        ...
        public Builder sendEmails(List<String> sendEmails) {
            if (sendEmails == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "sendEmails");
            }
        ...
        public Builder sendHttps(List<String> sendHttps) {
            if (sendHttps == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "sendHttps");
            }
        ...
        public Builder sendSnmptraps(List<String> sendSnmptraps) {
            if (sendSnmptraps == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "sendSnmptraps");
            }
        ...
        public Builder sendSyslogs(List<String> sendSyslogs) {
            if (sendSyslogs == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "sendSyslogs");
            }
        ...
        public Builder sendToPanorama(Boolean sendToPanorama) {
            if (sendToPanorama == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "sendToPanorama");
            }
        ...
        public Builder snippet(String snippet) {
            if (snippet == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "snippet");
            }
        ...
        public Builder tfid(String tfid) {
            if (tfid == null) {
              throw new MissingRequiredPropertyException("GetUseridMatchListListData", "tfid");
            }
            this.tfid = tfid;
            return this;
        }
        public GetUseridMatchListListData build() {
            final var _resultValue = new GetUseridMatchListListData();
