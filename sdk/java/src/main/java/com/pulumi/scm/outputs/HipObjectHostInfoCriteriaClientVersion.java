...
@CustomType
public final class HipObjectHostInfoCriteriaClientVersion {
    /**
    ...
    private HipObjectHostInfoCriteriaClientVersion() {}
    /**
     * @return The Contains param. String length must not exceed 255 characters. Ensure that only one of the following is specified: `contains`, `is`, `is_not`
     * 
     */
    ...
    public static Builder builder(HipObjectHostInfoCriteriaClientVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String isNot;
        public Builder() {}
        public Builder(HipObjectHostInfoCriteriaClientVersion defaults) {
        ...
        public HipObjectHostInfoCriteriaClientVersion build() {
            final var _resultValue = new HipObjectHostInfoCriteriaClientVersion();
