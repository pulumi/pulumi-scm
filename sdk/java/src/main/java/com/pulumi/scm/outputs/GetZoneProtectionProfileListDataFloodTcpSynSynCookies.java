...
@CustomType
public final class GetZoneProtectionProfileListDataFloodTcpSynSynCookies {
    /**
    ...
    private GetZoneProtectionProfileListDataFloodTcpSynSynCookies() {}
    /**
     * @return When the flow exceeds the `activateRate`` threshold, the firewall drops individual SYN packets randomly to restrict the flow.
     * 
     */
    ...
    public static Builder builder(GetZoneProtectionProfileListDataFloodTcpSynSynCookies defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maximalRate;
        public Builder() {}
        public Builder(GetZoneProtectionProfileListDataFloodTcpSynSynCookies defaults) {
        ...
        public Builder activateRate(Integer activateRate) {
            if (activateRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileListDataFloodTcpSynSynCookies", "activateRate");
            }
        ...
        public Builder alarmRate(Integer alarmRate) {
            if (alarmRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileListDataFloodTcpSynSynCookies", "alarmRate");
            }
        ...
        public Builder maximalRate(Integer maximalRate) {
            if (maximalRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileListDataFloodTcpSynSynCookies", "maximalRate");
            }
            this.maximalRate = maximalRate;
            return this;
        }
        public GetZoneProtectionProfileListDataFloodTcpSynSynCookies build() {
            final var _resultValue = new GetZoneProtectionProfileListDataFloodTcpSynSynCookies();
