...
@CustomType
public final class GetZoneProtectionProfileListDataFloodTcpSynRed {
    /**
    ...
    private GetZoneProtectionProfileListDataFloodTcpSynRed() {}
    /**
     * @return When the flow exceeds the `activateRate`` threshold, the firewall drops individual SYN packets randomly to restrict the flow.
     * 
     */
    ...
    public static Builder builder(GetZoneProtectionProfileListDataFloodTcpSynRed defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maximalRate;
        public Builder() {}
        public Builder(GetZoneProtectionProfileListDataFloodTcpSynRed defaults) {
        ...
        public Builder activateRate(Integer activateRate) {
            if (activateRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileListDataFloodTcpSynRed", "activateRate");
            }
        ...
        public Builder alarmRate(Integer alarmRate) {
            if (alarmRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileListDataFloodTcpSynRed", "alarmRate");
            }
        ...
        public Builder maximalRate(Integer maximalRate) {
            if (maximalRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileListDataFloodTcpSynRed", "maximalRate");
            }
            this.maximalRate = maximalRate;
            return this;
        }
        public GetZoneProtectionProfileListDataFloodTcpSynRed build() {
            final var _resultValue = new GetZoneProtectionProfileListDataFloodTcpSynRed();
