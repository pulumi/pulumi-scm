...
public final class BgpRouteMapRouteMapMatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final BgpRouteMapRouteMapMatchArgs Empty = new BgpRouteMapRouteMapMatchArgs();
     ...
     */
    @Import(name="ipv4")
    private @Nullable Output<BgpRouteMapRouteMapMatchIpv4Args> ipv4;

    /**
     * @return bgp-route-maps ipv4 object
     * 
     */
    public Optional<Output<BgpRouteMapRouteMapMatchIpv4Args>> ipv4() {
    ...
    private BgpRouteMapRouteMapMatchArgs() {}

    private BgpRouteMapRouteMapMatchArgs(BgpRouteMapRouteMapMatchArgs $) {
    ...
    public static Builder builder(BgpRouteMapRouteMapMatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BgpRouteMapRouteMapMatchArgs();
        }

        public Builder(BgpRouteMapRouteMapMatchArgs defaults) {
            $ = new BgpRouteMapRouteMapMatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param ipv4 bgp-route-maps ipv4 object
         * 
         * @return builder
         * 
         */
        public Builder ipv4(@Nullable Output<BgpRouteMapRouteMapMatchIpv4Args> ipv4) {
            $.ipv4 = ipv4;
            return this;
        }
         ...
         * 
         */
        public Builder ipv4(BgpRouteMapRouteMapMatchIpv4Args ipv4) {
        ...
        public BgpRouteMapRouteMapMatchArgs build() {
            return $;
        }
    }
