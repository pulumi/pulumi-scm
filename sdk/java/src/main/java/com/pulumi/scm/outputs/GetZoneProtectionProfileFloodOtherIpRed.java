...
@CustomType
public final class GetZoneProtectionProfileFloodOtherIpRed {
    /**
    ...
    private GetZoneProtectionProfileFloodOtherIpRed() {}
    /**
     * @return Activate rate
     * 
     */
    ...
    public static Builder builder(GetZoneProtectionProfileFloodOtherIpRed defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maximalRate;
        public Builder() {}
        public Builder(GetZoneProtectionProfileFloodOtherIpRed defaults) {
        ...
        public Builder activateRate(Integer activateRate) {
            if (activateRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileFloodOtherIpRed", "activateRate");
            }
        ...
        public Builder alarmRate(Integer alarmRate) {
            if (alarmRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileFloodOtherIpRed", "alarmRate");
            }
        ...
        public Builder maximalRate(Integer maximalRate) {
            if (maximalRate == null) {
              throw new MissingRequiredPropertyException("GetZoneProtectionProfileFloodOtherIpRed", "maximalRate");
            }
            this.maximalRate = maximalRate;
            return this;
        }
        public GetZoneProtectionProfileFloodOtherIpRed build() {
            final var _resultValue = new GetZoneProtectionProfileFloodOtherIpRed();
