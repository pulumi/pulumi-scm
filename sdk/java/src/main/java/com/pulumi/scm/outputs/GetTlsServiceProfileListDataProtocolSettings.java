...
@CustomType
public final class GetTlsServiceProfileListDataProtocolSettings {
    /**
    ...
    private GetTlsServiceProfileListDataProtocolSettings() {}
    /**
     * @return Allow authentication SHA1.
     * 
     */
    ...
    public static Builder builder(GetTlsServiceProfileListDataProtocolSettings defaults) {
    ...
    public static final class Builder {
        ...
        private String minVersion;
        public Builder() {}
        public Builder(GetTlsServiceProfileListDataProtocolSettings defaults) {
        ...
        public Builder authAlgoSha1(Boolean authAlgoSha1) {
            if (authAlgoSha1 == null) {
              throw new MissingRequiredPropertyException("GetTlsServiceProfileListDataProtocolSettings", "authAlgoSha1");
            }
        ...
        public Builder authAlgoSha256(Boolean authAlgoSha256) {
            if (authAlgoSha256 == null) {
              throw new MissingRequiredPropertyException("GetTlsServiceProfileListDataProtocolSettings", "authAlgoSha256");
            }
        ...
        public Builder authAlgoSha384(Boolean authAlgoSha384) {
            if (authAlgoSha384 == null) {
              throw new MissingRequiredPropertyException("GetTlsServiceProfileListDataProtocolSettings", "authAlgoSha384");
            }
        ...
        public Builder encAlgoAes128Gcm(Boolean encAlgoAes128Gcm) {
            if (encAlgoAes128Gcm == null) {
              throw new MissingRequiredPropertyException("GetTlsServiceProfileListDataProtocolSettings", "encAlgoAes128Gcm");
            }
        ...
        public Builder encAlgoAes256Cbc(Boolean encAlgoAes256Cbc) {
            if (encAlgoAes256Cbc == null) {
              throw new MissingRequiredPropertyException("GetTlsServiceProfileListDataProtocolSettings", "encAlgoAes256Cbc");
            }
        ...
        public Builder keyxchgAlgoDhe(Boolean keyxchgAlgoDhe) {
            if (keyxchgAlgoDhe == null) {
              throw new MissingRequiredPropertyException("GetTlsServiceProfileListDataProtocolSettings", "keyxchgAlgoDhe");
            }
        ...
        public Builder keyxchgAlgoEcdhe(Boolean keyxchgAlgoEcdhe) {
            if (keyxchgAlgoEcdhe == null) {
              throw new MissingRequiredPropertyException("GetTlsServiceProfileListDataProtocolSettings", "keyxchgAlgoEcdhe");
            }
        ...
        public Builder keyxchgAlgoRsa(Boolean keyxchgAlgoRsa) {
            if (keyxchgAlgoRsa == null) {
              throw new MissingRequiredPropertyException("GetTlsServiceProfileListDataProtocolSettings", "keyxchgAlgoRsa");
            }
        ...
        public Builder maxVersion(String maxVersion) {
            if (maxVersion == null) {
              throw new MissingRequiredPropertyException("GetTlsServiceProfileListDataProtocolSettings", "maxVersion");
            }
        ...
        public Builder minVersion(String minVersion) {
            if (minVersion == null) {
              throw new MissingRequiredPropertyException("GetTlsServiceProfileListDataProtocolSettings", "minVersion");
            }
            this.minVersion = minVersion;
            return this;
        }
        public GetTlsServiceProfileListDataProtocolSettings build() {
            final var _resultValue = new GetTlsServiceProfileListDataProtocolSettings();
