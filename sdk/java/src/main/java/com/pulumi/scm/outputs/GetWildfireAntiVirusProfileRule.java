...
public final class GetWildfireAntiVirusProfileRule {
    ...
    public static Builder builder(GetWildfireAntiVirusProfileRule defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetWildfireAntiVirusProfileRule defaults) {
        ...
        public Builder analysis(String analysis) {
            if (analysis == null) {
              throw new MissingRequiredPropertyException("GetWildfireAntiVirusProfileRule", "analysis");
            }
        ...
        public Builder applications(List<String> applications) {
            if (applications == null) {
              throw new MissingRequiredPropertyException("GetWildfireAntiVirusProfileRule", "applications");
            }
        ...
        public Builder direction(String direction) {
            if (direction == null) {
              throw new MissingRequiredPropertyException("GetWildfireAntiVirusProfileRule", "direction");
            }
        ...
        public Builder fileTypes(List<String> fileTypes) {
            if (fileTypes == null) {
              throw new MissingRequiredPropertyException("GetWildfireAntiVirusProfileRule", "fileTypes");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetWildfireAntiVirusProfileRule", "name");
            }
            this.name = name;
            return this;
        }
        public GetWildfireAntiVirusProfileRule build() {
            final var _resultValue = new GetWildfireAntiVirusProfileRule();
