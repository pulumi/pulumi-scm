...
public final class GetPbfRuleListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetPbfRuleListArgs Empty = new GetPbfRuleListArgs();
    ...
    private GetPbfRuleListArgs() {}

    private GetPbfRuleListArgs(GetPbfRuleListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetPbfRuleListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPbfRuleListArgs();
        }

        public Builder(GetPbfRuleListArgs defaults) {
            $ = new GetPbfRuleListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPbfRuleListArgs build() {
            return $;
        }
    }
