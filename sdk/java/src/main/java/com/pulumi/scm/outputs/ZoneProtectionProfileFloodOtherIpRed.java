...
@CustomType
public final class ZoneProtectionProfileFloodOtherIpRed {
    /**
    ...
    private ZoneProtectionProfileFloodOtherIpRed() {}
    /**
     * @return Activate rate
     * 
     */
    ...
    public static Builder builder(ZoneProtectionProfileFloodOtherIpRed defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maximalRate;
        public Builder() {}
        public Builder(ZoneProtectionProfileFloodOtherIpRed defaults) {
        ...
        public Builder activateRate(Integer activateRate) {
            if (activateRate == null) {
              throw new MissingRequiredPropertyException("ZoneProtectionProfileFloodOtherIpRed", "activateRate");
            }
        ...
        public Builder alarmRate(Integer alarmRate) {
            if (alarmRate == null) {
              throw new MissingRequiredPropertyException("ZoneProtectionProfileFloodOtherIpRed", "alarmRate");
            }
        ...
        public Builder maximalRate(Integer maximalRate) {
            if (maximalRate == null) {
              throw new MissingRequiredPropertyException("ZoneProtectionProfileFloodOtherIpRed", "maximalRate");
            }
            this.maximalRate = maximalRate;
            return this;
        }
        public ZoneProtectionProfileFloodOtherIpRed build() {
            final var _resultValue = new ZoneProtectionProfileFloodOtherIpRed();
