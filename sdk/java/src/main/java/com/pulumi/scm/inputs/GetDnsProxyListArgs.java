...
public final class GetDnsProxyListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDnsProxyListArgs Empty = new GetDnsProxyListArgs();
    ...
    private GetDnsProxyListArgs() {}

    private GetDnsProxyListArgs(GetDnsProxyListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetDnsProxyListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDnsProxyListArgs();
        }

        public Builder(GetDnsProxyListArgs defaults) {
            $ = new GetDnsProxyListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDnsProxyListArgs build() {
            return $;
        }
    }
