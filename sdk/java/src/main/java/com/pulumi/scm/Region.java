...
public class Region extends com.pulumi.resources.CustomResource {
     ...
     */
    public Region(String name, @Nullable RegionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Region(String name, @Nullable RegionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("scm:index/region:Region", name, args == null ? RegionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Region(String name, Output<String> id, @Nullable RegionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("scm:index/region:Region", name, state, makeResourceOptions(options, id));
    }
