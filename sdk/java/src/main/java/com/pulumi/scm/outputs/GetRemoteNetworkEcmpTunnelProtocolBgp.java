...
@CustomType
public final class GetRemoteNetworkEcmpTunnelProtocolBgp {
    /**
    ...
    private GetRemoteNetworkEcmpTunnelProtocolBgp() {}
    /**
     * @return The DoNotExportRoutes param.
     * 
     */
    ...
    public static Builder builder(GetRemoteNetworkEcmpTunnelProtocolBgp defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean summarizeMobileUserRoutes;
        public Builder() {}
        public Builder(GetRemoteNetworkEcmpTunnelProtocolBgp defaults) {
        ...
        public Builder doNotExportRoutes(Boolean doNotExportRoutes) {
            if (doNotExportRoutes == null) {
              throw new MissingRequiredPropertyException("GetRemoteNetworkEcmpTunnelProtocolBgp", "doNotExportRoutes");
            }
        ...
        public Builder enable(Boolean enable) {
            if (enable == null) {
              throw new MissingRequiredPropertyException("GetRemoteNetworkEcmpTunnelProtocolBgp", "enable");
            }
            this.enable = enable;
            return this;
        }
        ...
        public Builder localIpAddress(String localIpAddress) {
            if (localIpAddress == null) {
              throw new MissingRequiredPropertyException("GetRemoteNetworkEcmpTunnelProtocolBgp", "localIpAddress");
            }
        ...
        public Builder originateDefaultRoute(Boolean originateDefaultRoute) {
            if (originateDefaultRoute == null) {
              throw new MissingRequiredPropertyException("GetRemoteNetworkEcmpTunnelProtocolBgp", "originateDefaultRoute");
            }
        ...
        public Builder peerAs(String peerAs) {
            if (peerAs == null) {
              throw new MissingRequiredPropertyException("GetRemoteNetworkEcmpTunnelProtocolBgp", "peerAs");
            }
            this.peerAs = peerAs;
            return this;
        }
        ...
        public Builder peerIpAddress(String peerIpAddress) {
            if (peerIpAddress == null) {
              throw new MissingRequiredPropertyException("GetRemoteNetworkEcmpTunnelProtocolBgp", "peerIpAddress");
            }
        ...
        public Builder peeringType(String peeringType) {
            if (peeringType == null) {
              throw new MissingRequiredPropertyException("GetRemoteNetworkEcmpTunnelProtocolBgp", "peeringType");
            }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("GetRemoteNetworkEcmpTunnelProtocolBgp", "secret");
            }
            this.secret = secret;
            return this;
        }
        ...
        public Builder summarizeMobileUserRoutes(Boolean summarizeMobileUserRoutes) {
            if (summarizeMobileUserRoutes == null) {
              throw new MissingRequiredPropertyException("GetRemoteNetworkEcmpTunnelProtocolBgp", "summarizeMobileUserRoutes");
            }
            this.summarizeMobileUserRoutes = summarizeMobileUserRoutes;
            return this;
        }
        public GetRemoteNetworkEcmpTunnelProtocolBgp build() {
            final var _resultValue = new GetRemoteNetworkEcmpTunnelProtocolBgp();
