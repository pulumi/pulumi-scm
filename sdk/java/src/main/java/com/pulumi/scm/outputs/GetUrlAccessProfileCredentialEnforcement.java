...
import com.pulumi.scm.outputs.GetUrlAccessProfileCredentialEnforcementMode;
...
public final class GetUrlAccessProfileCredentialEnforcement {
    ...
    public static Builder builder(GetUrlAccessProfileCredentialEnforcement defaults) {
    ...
    public static final class Builder {
        ...
        private GetUrlAccessProfileCredentialEnforcementMode mode;
        public Builder() {}
        public Builder(GetUrlAccessProfileCredentialEnforcement defaults) {
        ...
        public Builder alerts(List<String> alerts) {
            if (alerts == null) {
              throw new MissingRequiredPropertyException("GetUrlAccessProfileCredentialEnforcement", "alerts");
            }
            this.alerts = alerts;
            return this;
        }
        ...
        public Builder allows(List<String> allows) {
            if (allows == null) {
              throw new MissingRequiredPropertyException("GetUrlAccessProfileCredentialEnforcement", "allows");
            }
            this.allows = allows;
            return this;
        }
        ...
        public Builder blocks(List<String> blocks) {
            if (blocks == null) {
              throw new MissingRequiredPropertyException("GetUrlAccessProfileCredentialEnforcement", "blocks");
            }
            this.blocks = blocks;
            return this;
        }
        ...
        public Builder continues(List<String> continues) {
            if (continues == null) {
              throw new MissingRequiredPropertyException("GetUrlAccessProfileCredentialEnforcement", "continues");
            }
        ...
        public Builder logSeverity(String logSeverity) {
            if (logSeverity == null) {
              throw new MissingRequiredPropertyException("GetUrlAccessProfileCredentialEnforcement", "logSeverity");
            }
            this.logSeverity = logSeverity;
            return this;
        }
        @CustomType.Setter
        public Builder mode(GetUrlAccessProfileCredentialEnforcementMode mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("GetUrlAccessProfileCredentialEnforcement", "mode");
            }
            this.mode = mode;
            return this;
        }
        public GetUrlAccessProfileCredentialEnforcement build() {
            final var _resultValue = new GetUrlAccessProfileCredentialEnforcement();
