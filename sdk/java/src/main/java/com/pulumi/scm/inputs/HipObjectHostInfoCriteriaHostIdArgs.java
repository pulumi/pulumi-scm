...
public final class HipObjectHostInfoCriteriaHostIdArgs extends com.pulumi.resources.ResourceArgs {

    public static final HipObjectHostInfoCriteriaHostIdArgs Empty = new HipObjectHostInfoCriteriaHostIdArgs();
    ...
    private HipObjectHostInfoCriteriaHostIdArgs() {}

    private HipObjectHostInfoCriteriaHostIdArgs(HipObjectHostInfoCriteriaHostIdArgs $) {
    ...
    public static Builder builder(HipObjectHostInfoCriteriaHostIdArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HipObjectHostInfoCriteriaHostIdArgs();
        }

        public Builder(HipObjectHostInfoCriteriaHostIdArgs defaults) {
            $ = new HipObjectHostInfoCriteriaHostIdArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HipObjectHostInfoCriteriaHostIdArgs build() {
            return $;
        }
    }
