...
@CustomType
public final class HipObjectHostInfoCriteriaHostName {
    /**
    ...
    public static Builder builder(HipObjectHostInfoCriteriaHostName defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String isNot;
        public Builder() {}
        public Builder(HipObjectHostInfoCriteriaHostName defaults) {
        ...
        public HipObjectHostInfoCriteriaHostName build() {
            final var _resultValue = new HipObjectHostInfoCriteriaHostName();
