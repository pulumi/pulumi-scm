...
import com.pulumi.scm.outputs.DosProtectionProfileFloodIcmpRedBlock;
...
@CustomType
public final class DosProtectionProfileFloodIcmpRed {
    /**
     ...
     * 
     */
    private @Nullable DosProtectionProfileFloodIcmpRedBlock block;
    /**
     * @return Maximal rate
     * 
     */
    ...
    private DosProtectionProfileFloodIcmpRed() {}
    /**
     * @return Activate rate
     * 
     */
     ...
     * 
     */
    public Optional<DosProtectionProfileFloodIcmpRedBlock> block() {
    ...
    public static Builder builder(DosProtectionProfileFloodIcmpRed defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer maximalRate;
        public Builder() {}
        public Builder(DosProtectionProfileFloodIcmpRed defaults) {
        ...
        @CustomType.Setter
        public Builder block(@Nullable DosProtectionProfileFloodIcmpRedBlock block) {
        ...
        public DosProtectionProfileFloodIcmpRed build() {
            final var _resultValue = new DosProtectionProfileFloodIcmpRed();
