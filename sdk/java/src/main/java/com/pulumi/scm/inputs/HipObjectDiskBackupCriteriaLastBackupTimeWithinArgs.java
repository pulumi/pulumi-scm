...
public final class HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs extends com.pulumi.resources.ResourceArgs {

    public static final HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs Empty = new HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs();
    ...
    private HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs() {}

    private HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs(HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs $) {
        this.days = $.days;
        this.hours = $.hours;
    }
    ...
    public static Builder builder(HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs();
        }

        public Builder(HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs defaults) {
            $ = new HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HipObjectDiskBackupCriteriaLastBackupTimeWithinArgs build() {
            return $;
        }
    }
