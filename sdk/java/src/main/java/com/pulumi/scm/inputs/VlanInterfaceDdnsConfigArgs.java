    ...
    public static final class Builder {
        ...
        public VlanInterfaceDdnsConfigArgs build() {
            if ($.ddnsCertProfile == null) {
                throw new MissingRequiredPropertyException("VlanInterfaceDdnsConfigArgs", "ddnsCertProfile");
            }
            if ($.ddnsHostname == null) {
                throw new MissingRequiredPropertyException("VlanInterfaceDdnsConfigArgs", "ddnsHostname");
            }
            if ($.ddnsVendor == null) {
                throw new MissingRequiredPropertyException("VlanInterfaceDdnsConfigArgs", "ddnsVendor");
            }
            if ($.ddnsVendorConfig == null) {
                throw new MissingRequiredPropertyException("VlanInterfaceDdnsConfigArgs", "ddnsVendorConfig");
            }
            return $;
        }
    }
