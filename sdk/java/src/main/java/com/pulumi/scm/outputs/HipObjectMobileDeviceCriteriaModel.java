...
@CustomType
public final class HipObjectMobileDeviceCriteriaModel {
    /**
    ...
    private HipObjectMobileDeviceCriteriaModel() {}
    /**
     * @return The Contains param. String length must not exceed 255 characters. Ensure that only one of the following is specified: `contains`, `is`, `is_not`
     * 
     */
    ...
    public static Builder builder(HipObjectMobileDeviceCriteriaModel defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String isNot;
        public Builder() {}
        public Builder(HipObjectMobileDeviceCriteriaModel defaults) {
        ...
        public HipObjectMobileDeviceCriteriaModel build() {
            final var _resultValue = new HipObjectMobileDeviceCriteriaModel();
