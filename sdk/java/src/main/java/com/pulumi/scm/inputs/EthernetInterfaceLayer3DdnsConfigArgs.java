...
public final class EthernetInterfaceLayer3DdnsConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final EthernetInterfaceLayer3DdnsConfigArgs Empty = new EthernetInterfaceLayer3DdnsConfigArgs();
    ...
    private EthernetInterfaceLayer3DdnsConfigArgs() {}

    private EthernetInterfaceLayer3DdnsConfigArgs(EthernetInterfaceLayer3DdnsConfigArgs $) {
    ...
    public static Builder builder(EthernetInterfaceLayer3DdnsConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EthernetInterfaceLayer3DdnsConfigArgs();
        }

        public Builder(EthernetInterfaceLayer3DdnsConfigArgs defaults) {
            $ = new EthernetInterfaceLayer3DdnsConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EthernetInterfaceLayer3DdnsConfigArgs build() {
            if ($.ddnsCertProfile == null) {
                throw new MissingRequiredPropertyException("EthernetInterfaceLayer3DdnsConfigArgs", "ddnsCertProfile");
            }
            if ($.ddnsHostname == null) {
                throw new MissingRequiredPropertyException("EthernetInterfaceLayer3DdnsConfigArgs", "ddnsHostname");
            }
            if ($.ddnsVendor == null) {
                throw new MissingRequiredPropertyException("EthernetInterfaceLayer3DdnsConfigArgs", "ddnsVendor");
            }
            if ($.ddnsVendorConfig == null) {
                throw new MissingRequiredPropertyException("EthernetInterfaceLayer3DdnsConfigArgs", "ddnsVendorConfig");
            }
            return $;
        }
    }
