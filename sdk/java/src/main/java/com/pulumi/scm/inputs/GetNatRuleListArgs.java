...
public final class GetNatRuleListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetNatRuleListArgs Empty = new GetNatRuleListArgs();
    ...
    private GetNatRuleListArgs() {}

    private GetNatRuleListArgs(GetNatRuleListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetNatRuleListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNatRuleListArgs();
        }

        public Builder(GetNatRuleListArgs defaults) {
            $ = new GetNatRuleListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNatRuleListArgs build() {
            if ($.position == null) {
                throw new MissingRequiredPropertyException("GetNatRuleListArgs", "position");
            }
            return $;
        }
    }
