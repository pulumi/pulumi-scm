...
@CustomType
public final class IpsecTunnelAutoKeyProxyIdV6ProtocolTcp {
    /**
    ...
    private IpsecTunnelAutoKeyProxyIdV6ProtocolTcp() {}
    /**
     * @return The LocalPort param. Value must be between 0 and 65535. Default: `0`.
     * 
     */
    ...
    public static Builder builder(IpsecTunnelAutoKeyProxyIdV6ProtocolTcp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer remotePort;
        public Builder() {}
        public Builder(IpsecTunnelAutoKeyProxyIdV6ProtocolTcp defaults) {
        ...
        public IpsecTunnelAutoKeyProxyIdV6ProtocolTcp build() {
            final var _resultValue = new IpsecTunnelAutoKeyProxyIdV6ProtocolTcp();
