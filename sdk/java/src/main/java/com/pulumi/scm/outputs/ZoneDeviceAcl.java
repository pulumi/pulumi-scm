...
@CustomType
public final class ZoneDeviceAcl {
    /**
     * @return Exclude list
     * 
     */
    ...
    public static Builder builder(ZoneDeviceAcl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includeLists;
        public Builder() {}
        public Builder(ZoneDeviceAcl defaults) {
        ...
        public ZoneDeviceAcl build() {
            final var _resultValue = new ZoneDeviceAcl();
