...
@CustomType
public final class BgpRouteMapRouteMapSetIpv4 {
    /**
     * @return Next hop
     * 
     */
    ...
    private BgpRouteMapRouteMapSetIpv4() {}
    /**
     * @return Next hop
     * 
     */
    ...
    public static Builder builder(BgpRouteMapRouteMapSetIpv4 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sourceAddress;
        public Builder() {}
        public Builder(BgpRouteMapRouteMapSetIpv4 defaults) {
        ...
        public BgpRouteMapRouteMapSetIpv4 build() {
            final var _resultValue = new BgpRouteMapRouteMapSetIpv4();
