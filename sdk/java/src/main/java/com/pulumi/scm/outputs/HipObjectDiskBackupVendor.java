...
public final class HipObjectDiskBackupVendor {
    ...
    public static Builder builder(HipObjectDiskBackupVendor defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> products;
        public Builder() {}
        public Builder(HipObjectDiskBackupVendor defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("HipObjectDiskBackupVendor", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public HipObjectDiskBackupVendor build() {
            final var _resultValue = new HipObjectDiskBackupVendor();
