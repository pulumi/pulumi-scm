...
@CustomType
public final class LogicalRouterVrfOspfv3AreaInterfaceVrTiming {
    /**
     * @return Dead counts
     * 
     */
    ...
    public static Builder builder(LogicalRouterVrfOspfv3AreaInterfaceVrTiming defaults) {
    ...
    public static final class Builder {
        ...
        public LogicalRouterVrfOspfv3AreaInterfaceVrTiming build() {
            final var _resultValue = new LogicalRouterVrfOspfv3AreaInterfaceVrTiming();
