...
public final class AntiSpywareProfileRuleActionBlockIpArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AntiSpywareProfileRuleActionBlockIpArgs() {}

    private AntiSpywareProfileRuleActionBlockIpArgs(AntiSpywareProfileRuleActionBlockIpArgs $) {
    ...
    public static Builder builder(AntiSpywareProfileRuleActionBlockIpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AntiSpywareProfileRuleActionBlockIpArgs();
        }

        public Builder(AntiSpywareProfileRuleActionBlockIpArgs defaults) {
            $ = new AntiSpywareProfileRuleActionBlockIpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AntiSpywareProfileRuleActionBlockIpArgs build() {
            return $;
        }
    }
