...
public final class GetZoneListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetZoneListArgs Empty = new GetZoneListArgs();
    ...
    private GetZoneListArgs() {}

    private GetZoneListArgs(GetZoneListArgs $) {
        this.device = $.device;
        this.folder = $.folder;
        this.limit = $.limit;
        this.name = $.name;
    ...
    public static Builder builder(GetZoneListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetZoneListArgs defaults) {
            $ = new GetZoneListArgs(Objects.requireNonNull(defaults));
        }
