...
import com.pulumi.scm.outputs.GetHipObjectListDataCustomChecksCriteriaRegistryKeyRegistryValue;
...
public final class GetHipObjectListDataCustomChecksCriteriaRegistryKey {
    ...
    public static Builder builder(GetHipObjectListDataCustomChecksCriteriaRegistryKey defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetHipObjectListDataCustomChecksCriteriaRegistryKeyRegistryValue> registryValues;
        public Builder() {}
        public Builder(GetHipObjectListDataCustomChecksCriteriaRegistryKey defaults) {
        ...
        public Builder defaultValueData(String defaultValueData) {
            if (defaultValueData == null) {
              throw new MissingRequiredPropertyException("GetHipObjectListDataCustomChecksCriteriaRegistryKey", "defaultValueData");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetHipObjectListDataCustomChecksCriteriaRegistryKey", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder negate(Boolean negate) {
            if (negate == null) {
              throw new MissingRequiredPropertyException("GetHipObjectListDataCustomChecksCriteriaRegistryKey", "negate");
            }
            this.negate = negate;
            return this;
        }
        @CustomType.Setter
        public Builder registryValues(List<GetHipObjectListDataCustomChecksCriteriaRegistryKeyRegistryValue> registryValues) {
            if (registryValues == null) {
              throw new MissingRequiredPropertyException("GetHipObjectListDataCustomChecksCriteriaRegistryKey", "registryValues");
            }
            this.registryValues = registryValues;
            return this;
        }
        public Builder registryValues(GetHipObjectListDataCustomChecksCriteriaRegistryKeyRegistryValue... registryValues) {
            return registryValues(List.of(registryValues));
        }
        public GetHipObjectListDataCustomChecksCriteriaRegistryKey build() {
            final var _resultValue = new GetHipObjectListDataCustomChecksCriteriaRegistryKey();
