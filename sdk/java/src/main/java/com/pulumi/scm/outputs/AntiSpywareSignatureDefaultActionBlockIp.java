...
@CustomType
public final class AntiSpywareSignatureDefaultActionBlockIp {
    /**
    ...
    private AntiSpywareSignatureDefaultActionBlockIp() {}
    /**
     * @return The Duration param. Value must be between 1 and 3600.
     * 
     */
    ...
    public static Builder builder(AntiSpywareSignatureDefaultActionBlockIp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String trackBy;
        public Builder() {}
        public Builder(AntiSpywareSignatureDefaultActionBlockIp defaults) {
        ...
        public AntiSpywareSignatureDefaultActionBlockIp build() {
            final var _resultValue = new AntiSpywareSignatureDefaultActionBlockIp();
