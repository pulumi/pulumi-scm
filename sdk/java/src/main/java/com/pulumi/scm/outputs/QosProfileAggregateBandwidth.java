...
public final class QosProfileAggregateBandwidth {
    ...
    public static Builder builder(QosProfileAggregateBandwidth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer egressMax;
        public Builder() {}
        public Builder(QosProfileAggregateBandwidth defaults) {
        ...
        public QosProfileAggregateBandwidth build() {
            final var _resultValue = new QosProfileAggregateBandwidth();
