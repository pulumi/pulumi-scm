...
public final class HipObjectDiskBackupVendorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HipObjectDiskBackupVendorArgs() {}

    private HipObjectDiskBackupVendorArgs(HipObjectDiskBackupVendorArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(HipObjectDiskBackupVendorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HipObjectDiskBackupVendorArgs();
        }

        public Builder(HipObjectDiskBackupVendorArgs defaults) {
            $ = new HipObjectDiskBackupVendorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HipObjectDiskBackupVendorArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("HipObjectDiskBackupVendorArgs", "name");
            }
            return $;
        }
    }
