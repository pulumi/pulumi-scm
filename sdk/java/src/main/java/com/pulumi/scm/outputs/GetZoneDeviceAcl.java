...
@CustomType
public final class GetZoneDeviceAcl {
    /**
     * @return Exclude list
     * 
     */
    ...
    public static Builder builder(GetZoneDeviceAcl defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> includeLists;
        public Builder() {}
        public Builder(GetZoneDeviceAcl defaults) {
        ...
        public Builder excludeLists(List<String> excludeLists) {
            if (excludeLists == null) {
              throw new MissingRequiredPropertyException("GetZoneDeviceAcl", "excludeLists");
            }
        ...
        public Builder includeLists(List<String> includeLists) {
            if (includeLists == null) {
              throw new MissingRequiredPropertyException("GetZoneDeviceAcl", "includeLists");
            }
        ...
        public GetZoneDeviceAcl build() {
            final var _resultValue = new GetZoneDeviceAcl();
