...
public final class ZoneUserAclArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZoneUserAclArgs Empty = new ZoneUserAclArgs();
    ...
    private ZoneUserAclArgs() {}

    private ZoneUserAclArgs(ZoneUserAclArgs $) {
    ...
    public static Builder builder(ZoneUserAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ZoneUserAclArgs defaults) {
            $ = new ZoneUserAclArgs(Objects.requireNonNull(defaults));
        }
