...
public final class LogicalRouterVrfOspfAreaInterfaceVrTimingArgs extends com.pulumi.resources.ResourceArgs {

    public static final LogicalRouterVrfOspfAreaInterfaceVrTimingArgs Empty = new LogicalRouterVrfOspfAreaInterfaceVrTimingArgs();
    ...
    private LogicalRouterVrfOspfAreaInterfaceVrTimingArgs() {}

    private LogicalRouterVrfOspfAreaInterfaceVrTimingArgs(LogicalRouterVrfOspfAreaInterfaceVrTimingArgs $) {
    ...
    public static Builder builder(LogicalRouterVrfOspfAreaInterfaceVrTimingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogicalRouterVrfOspfAreaInterfaceVrTimingArgs();
        }

        public Builder(LogicalRouterVrfOspfAreaInterfaceVrTimingArgs defaults) {
            $ = new LogicalRouterVrfOspfAreaInterfaceVrTimingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LogicalRouterVrfOspfAreaInterfaceVrTimingArgs build() {
            return $;
        }
    }
